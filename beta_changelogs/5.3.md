...
- The HUD now updates between versions and applies changes to selected
...
- Replace the resources.zip and the datapacks/Fetchr.zip with the new data- and
  resource pack
- Optionally replace the level.dat
  - In singleplayer, this will delete the player inventory and ender chest. In
    mulitplayer, all player data is preserved
  - When updating versions 5.1-beta1 - 5.1-beta3, replacing the level.dat is
    mandantory
...
- `#fetchr:start_sequence/countdown_ended`: The countdown ended and the game
  starts
- `#fetchr:game/ended`: The current game has ended
