...
random.seed(91)
write_biome_list(0.6, warm_biomes, warm_hill_biomes, 13)
file.write(',')
write_biome_list(0.25, medium_biomes, medium_hill_biomes, 13)
file.write(',')
write_biome_list(-0.25, cold_biomes, cold_hill_biomes,13)
file.write(',')
write_biome_list(-0.6, ice_biomes, ice_hill_biomes, 13)
