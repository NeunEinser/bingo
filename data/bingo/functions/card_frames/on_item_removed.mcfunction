...
data modify storage tmp.bingo:input/card_item slots set from storage bingo:card slots
...
data modify entity @s Item set from storage tmp.bingo:output/card_item found_item
