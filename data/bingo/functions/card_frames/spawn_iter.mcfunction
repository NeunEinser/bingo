...
# 	function bingo:card_frames/spawn
# 	function bingo:card_frames/spawn_iter
#declare storage tmp.bingo:input/spawn_frames
...
data modify entity @e[type=minecraft:item_frame, tag=bingo.new, limit=1] Item set from storage tmp.bingo:input/spawn_frames slots[0].item.item
data remove storage tmp.bingo:input/spawn_frames slots[0]
