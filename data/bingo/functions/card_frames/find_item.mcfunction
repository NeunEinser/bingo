...
# tmp.bingo:output/card_item
#
# @internal
# @input
# 	score $card_frames/find_item.slot_id bingo.tmp The slot index of which the
# 		item should be returned.
# 	storage tmp.bingo:input/card_item slots The slots of the current card
# @output storage tmp.bingo:output/card_item found_item
...
#
# @internal
#declare storage tmp.bingo:input/card_item
...
#
# @internal
#declare storage tmp.bingo:output/card_item

execute if score $card_frames/find_item.slot_id bingo.tmp matches 0 run data modify storage tmp.bingo:output/card_item found_item set from storage tmp.bingo:input/card_item slots[0].item.item
execute if score $card_frames/find_item.slot_id bingo.tmp matches 0 unless data storage tmp.bingo:input/card_item slots[0].item.item run data modify storage tmp.bingo:output/card_item found_item set value {id: "minecraft:barrier", Count: 1b}

data remove storage tmp.bingo:input/card_item slots[0]
