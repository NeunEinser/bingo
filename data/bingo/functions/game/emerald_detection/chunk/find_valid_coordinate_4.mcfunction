#> bingo:game/emerald_detection/chunk/find_valid_coordinate_4
#
# i = 5 (bitmask 101)
#
# @within function bingo:game/emerald_detection/chunk/find_valid_coordinate_3

#region load cached unsalted lcg result for lcg call 3

scoreboard players operation $detect_emerald/chunk.seed_low bingo.tmp = $detect_emerald/chunk.cache_pxny_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.seed_high bingo.tmp = $detect_emerald/chunk.cache_pxny_high bingo.tmp
...
execute if score $detect_emerald/chunk.min_distance bingo.tmp <= $detect_emerald/chunk.cur_distance bingo.tmp run function bingo:game/emerald_detection/chunk/find_valid_coordinate_5
#endregion
