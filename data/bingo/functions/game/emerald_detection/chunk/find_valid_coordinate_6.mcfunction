#> bingo:game/emerald_detection/chunk/find_valid_coordinate_6
#
# i = 7 (bitmask 111)
#
# @within function bingo:game/emerald_detection/chunk/find_valid_coordinate_5

#region load cached unsalted lcg result for lcg call 3

scoreboard players operation $detect_emerald/chunk.seed_low bingo.tmp = $detect_emerald/chunk.cache_pxpy_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.seed_high bingo.tmp = $detect_emerald/chunk.cache_pxpy_high bingo.tmp
...
# Found something
execute if score $detect_emerald/chunk.min_distance bingo.tmp <= $detect_emerald/chunk.cur_distance bingo.tmp run say Found good coordinate!
#endregion
