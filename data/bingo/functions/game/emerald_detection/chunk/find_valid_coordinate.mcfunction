...
scoreboard players operation $detect_emerald/chunk.cache_nx_low bingo.tmp = $detect_emerald/chunk.seed_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.cache_nx_high bingo.tmp = $detect_emerald/chunk.seed_high bingo.tmp
...
scoreboard players operation $detect_emerald/chunk.cache_nxny_low bingo.tmp = $detect_emerald/chunk.seed_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.cache_nxny_high bingo.tmp = $detect_emerald/chunk.seed_high bingo.tmp
...
execute if score $detect_emerald/chunk.min_distance bingo.tmp matches ..-1 run scoreboard players add $detect_emerald/chunk.min_distance bingo.tmp 256
...
#region i = 2 (bitmask 010)
# i = 2 is executed now, since it is the second position that can be used (since
# biomes are the same in the same y column)
#
...
scoreboard players operation $detect_emerald/chunk.cache_nxpy_low bingo.tmp = $detect_emerald/chunk.seed_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.cache_nxpy_high bingo.tmp = $detect_emerald/chunk.seed_high bingo.tmp
