#> bingo:game/emerald_detection/chunk/find_valid_coordinate_3
#
# i = 4 (bitmask 100)
#
# @within function bingo:game/emerald_detection/chunk/find_valid_coordinate_2

#region set unsalted lcg result for lcg call 1
...
# Add salt (in this case biome x pos offset)
...
scoreboard players operation $detect_emerald/chunk.cache_px_low bingo.tmp = $detect_emerald/chunk.seed_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.cache_px_high bingo.tmp = $detect_emerald/chunk.seed_high bingo.tmp
...
scoreboard players operation $detect_emerald/chunk.cache_pxny_low bingo.tmp = $detect_emerald/chunk.seed_low bingo.tmp
scoreboard players operation $detect_emerald/chunk.cache_pxny_high bingo.tmp = $detect_emerald/chunk.seed_high bingo.tmp
...
execute if score $detect_emerald/chunk.min_distance bingo.tmp <= $detect_emerald/chunk.cur_distance bingo.tmp run function bingo:game/emerald_detection/chunk/find_valid_coordinate_4
#endregion
