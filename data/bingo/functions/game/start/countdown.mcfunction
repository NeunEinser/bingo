...
execute if score $start_game.countdown bingo.schedule matches 1.. as @a[predicate=bingo:is_in_game] at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~ 1 2
