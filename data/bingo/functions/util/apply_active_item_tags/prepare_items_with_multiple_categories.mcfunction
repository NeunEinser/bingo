...
execute store result score $apply_tags/mult_cat.nom bingo.tmp run data get storage tmp.bingo:apply_active_item_tags items[-1].weight
...
execute store result storage tmp.bingo:apply_active_item_tags items[-1].weight int 1 run scoreboard players get $apply_tags/mult_cat.nom bingo.tmp
...
scoreboard players operation $apply_tags/mult_cat.denom bingo.tmp /= $gcd.result 91.math.io
scoreboard players operation $apply_tags.weight_multiplier bingo.tmp *= $apply_tags/mult_cat.denom bingo.tmp
