...
execute if score $custom_hud/player_pos.x bingo.tmp matches ..-1 run scoreboard players add $custom_hud/player_pos.hash bingo.tmp 256
...
scoreboard players operation $custom_hud/player_pos.hash_y bingo.tmp %= 256 bingo.const
execute if score $custom_hud/player_pos.z bingo.tmp matches ..-1 run scoreboard players add $custom_hud/player_pos.hash_y bingo.tmp 256
...
scoreboard players operation $custom_hud/player_pos.hash_z bingo.tmp %= 256 bingo.const
execute if score $custom_hud/player_pos.z bingo.tmp matches ..-1 run scoreboard players add $custom_hud/player_pos.hash_z bingo.tmp 256
...
scoreboard players operation $custom_hud/player_pos.hash bingo.tmp *= 512 bingo.const
