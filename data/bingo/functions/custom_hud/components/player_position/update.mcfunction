...
data modify storage temp:bingo.custom_hud component set value {textComponent:'[{"storage": "bingo:custom_hud", "nbt": "params.bingo.player_position.x"}, " ", {"storage": "bingo:custom_hud", "nbt": "params.bingo.player_position.z"}]', changed: true, iconWidth: '{"translate": "space.10"}'}
...
execute if score $custom_hud/player_pos.line bingo.tmp matches 1 run data modify storage temp:bingo.custom_hud component.iconFont set value '{"text":"", "font": "bingo:compass/line_1"}'
execute if score $custom_hud/player_pos.line bingo.tmp matches 2 run data modify storage temp:bingo.custom_hud component.iconFont set value '{"text":"", "font": "bingo:compass/line_2"}'
execute if score $custom_hud/player_pos.line bingo.tmp matches 3 run data modify storage temp:bingo.custom_hud component.iconFont set value '{"text":"", "font": "bingo:compass/line_3"}'
execute if score $custom_hud/player_pos.line bingo.tmp matches 4 run data modify storage temp:bingo.custom_hud component.iconFont set value '{"text":"", "font": "bingo:compass/line_4"}'
