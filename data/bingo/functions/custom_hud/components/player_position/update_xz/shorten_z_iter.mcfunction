#> bingo:custom_hud/components/player_position/update_xz/shorten_z_iter
#
...
execute if score $custom_hud/width.characters bingo.io matches 12.. run function bingo:custom_hud/components/player_position/update_xz/shorten_z_iter