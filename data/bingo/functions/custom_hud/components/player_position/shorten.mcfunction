#> bingo:custom_hud/components/player_position/shorten
#
...
execute if score $custom_hud/player_pos.shorten_both bingo.tmp matches 0 if score $custom_hud/player_pos.abs_x bingo.tmp >= $custom_hud/player_pos.abs_z bingo.tmp run function bingo:custom_hud/components/player_position/shorten_x
execute if score $custom_hud/player_pos.shorten_both bingo.tmp matches 0 if score $custom_hud/player_pos.abs_z bingo.tmp > $custom_hud/player_pos.abs_x bingo.tmp run function bingo:custom_hud/components/player_position/shorten_z
execute if score $custom_hud/player_pos.shorten_both bingo.tmp matches 1 run function bingo:custom_hud/components/player_position/shorten_both