...
data modify storage io.bingo:custom_hud component set from storage bingo:custom_hud currentPlayer.components[{id: "bingo:player_chunk_position"}]
...
data modify storage bingo:custom_hud currentPlayer.components[{id: "bingo:player_chunk_position"}] set from storage io.bingo:custom_hud component