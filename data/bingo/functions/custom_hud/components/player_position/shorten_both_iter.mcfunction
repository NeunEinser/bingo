#> bingo:custom_hud/components/player_position/shorten_both_iter
#
...
execute if score $custom_hud/width.characters bingo.io matches 13.. if score $custom_hud/player_pos.removed_x bingo.tmp < $custom_hud/player_pos.max_secondary bingo.tmp run function bingo:custom_hud/components/player_position/shorten_both_iter