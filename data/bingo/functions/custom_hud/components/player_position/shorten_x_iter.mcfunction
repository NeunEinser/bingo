#> bingo:custom_hud/components/player_position/shorten_x_iter
#
...
execute if score $custom_hud/width.characters bingo.io matches 12.. run function bingo:custom_hud/components/player_position/shorten_x_iter