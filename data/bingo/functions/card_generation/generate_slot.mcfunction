...
execute as @e[type=minecraft:item_frame, tag=bingo_card_frame] if score @s bingo.frame_id = $i bingo.tmp run data modify entity @s Item set from storage bingo:tmp item.item
