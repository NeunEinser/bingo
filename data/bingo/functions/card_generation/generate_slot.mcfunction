...
data modify block 7 0 7 Text1 set value '["", {"translate": "space.2", "font": "space:default"}, {"storage": "tmp.bingo:card_generation", "nbt":"items[-1].icon", "interpret": true}]'
data modify storage bingo:card slots[-1].display set from block 7 0 7 Text1
