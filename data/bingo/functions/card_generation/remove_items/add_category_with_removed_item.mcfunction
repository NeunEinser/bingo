...
execute if score $card_gen.aec_tag_count bingo.tmp > $card_gen/remove_items.tag_count bingo.tmp run data modify storage tmp.bingo:card_generation categoriesWithRemovedItem append from storage tmp.bingo:card_generation itemCategories[-1]
