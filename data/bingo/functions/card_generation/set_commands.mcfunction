...
scoreboard players operation $card_gen/slot.z bingo.tmp /= 50 bingo.const
...
execute unless score $card_gen/slot.xmod bingo.tmp = $card_gen/slot.zmod bingo.tmp run scoreboard players remove $card_gen/slot.y bingo.tmp 9
