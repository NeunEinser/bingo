...
setblock 1 2 1 minecraft:warped_wall_sign{Text1: '{"translate": "%1074992263$s%1$s", "color": "#8eedeb", "with": ["", {"translate": "%1074992263$s%3$s%1$s", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "with": ["", {"translate": "bingo.resourcepack_check.wrong_version.sign.line1"}], "bold":true}, {"translate": "bingo.resourcepack_check.sign.line1"}]}], "clickEvent": {"action": "run_command", "value": "/trigger bingo.resources"}}', Text2: '{"translate": "%1074992263$s%1$s", "color": "#8eedeb", "with": [{"text": "Download", "bold":true}, {"translate": "%1074992263$s%3$s%1$s", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "with": [{"text": "Download"}, {"translate": "bingo.resourcepack_check.wrong_version.sign.line2"}], "bold":true}, {"translate": "bingo.resourcepack_check.sign.line2"}]}]}', Text3: '{"translate": "%1074992263$s%1$s", "color": "#8eedeb", "with": [{"text": "Resourcepack", "bold":true}, {"translate": "%1074992263$s%3$s%1$s", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "with": [{"text": "Resourcepack"}, {"translate": "bingo.resourcepack_check.wrong_version.sign.line3"}], "bold":true}, {"translate": "bingo.resourcepack_check.sign.line3"}]}]}', Text4: '{"translate": "%1074992263$s%1$s", "color": "#8eedeb", "with": ["", {"translate": "%1074992263$s%3$s%1$s", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "with": ["", {"translate": "bingo.resourcepack_check.wrong_version.sign.line4"}], "bold":true}, {"translate": "bingo.resourcepack_check.sign.line4"}]}]}'}
#endregion
