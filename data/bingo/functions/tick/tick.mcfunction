...
setblock 1 2 1 minecraft:warped_wall_sign{Text1: '{"translate": "%1074992263$s%3$s%1$s", "color": "#8eedeb", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "bold":true, "with": ["", {"translate": "bingo.resourcepack_check.wrong_version.sign.line1"}]}, {"translate": "bingo.resourcepack_check.sign.line1"}], "clickEvent": {"action": "run_command", "value": "/trigger bingo.resources"}}',Text2: '{"translate": "%1074992263$s%3$s%1$s", "color": "#8eedeb", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "bold":true, "with": ["Download", {"translate": "bingo.resourcepack_check.wrong_version.sign.line2"}]}, {"translate": "bingo.resourcepack_check.sign.line2"}]}',Text3: '{"translate": "%1074992263$s%3$s%1$s", "color": "#8eedeb", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "bold":true, "with": ["Resourcepack", {"translate": "bingo.resourcepack_check.wrong_version.sign.line3"}]}, {"translate": "bingo.resourcepack_check.sign.line3"}]}',Text4: '{"translate": "%1074992263$s%3$s%1$s", "color": "#8eedeb", "with": [{"translate": "%1074992263$s%3$s%3$s%1$s", "bold":true, "with": ["", {"translate": "bingo.resourcepack_check.wrong_version.sign.line4"}]}, {"translate": "bingo.resourcepack_check.sign.line4"}]}'}
#endregion
...
execute if score $commandblocks_enabled bingo.state matches 0 run tellraw @a {"translate":"%1074992263$s%1$s", "color": "red", "with":[["Command blocks are disabled on this server. Please make sure the server.properties file does have all mentioned values set as described ", {"text": "here", "color": "#00c3ff", "clickEvent": {"action": "open_url", "value": "https://github.com/NeunEinser/bingo/blob/5.0-pre2/server.properties"}}, "."], {"translate": "bingo.error.command_blocks_disabled", "with": [{"translate": "bingo.error.command_blocks_disabled.link", "color": "#00c3ff", "clickEvent": {"action": "open_url", "value": "https://github.com/NeunEinser/bingo/blob/5.0-pre2/server.properties"}}]}]}