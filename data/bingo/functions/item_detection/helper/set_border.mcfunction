...
#
# @within function bingo:item_detection/helper/check_and_announce
# @output score $item_detect/set_border.success bingo.tmp
...
#
# @within
# 	function bingo:item_detection/helper/check_and_announce
# 	function bingo:item_detection/helper/set_border 
