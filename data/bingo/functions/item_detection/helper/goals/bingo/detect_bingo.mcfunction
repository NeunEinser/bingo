...
execute if score $row bingo.tmp matches 0 if score $col bingo.tmp matches 0 if score $diag bingo.tmp matches 0 if score $items bingo.tmp matches 20 run function bingo:item_detection/helper/goals/announce_20_no_bingo