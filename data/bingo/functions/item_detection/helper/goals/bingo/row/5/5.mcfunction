...
execute store success score $item_detect/bingo/row/5/5.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/row/5 icon set from storage temp:bingo.item_detect/bingo/row/5 slots[24]
