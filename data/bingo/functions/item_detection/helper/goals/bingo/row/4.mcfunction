...
execute store success score $item_detect/bingo/row/4/1.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/row/4 icon set from storage temp:bingo.item_detect/bingo/row/4 slots[15]
