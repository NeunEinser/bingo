...
execute store success score $item_detect/bingo/row/2/1.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/row/2 icon set from storage temp:bingo.item_detect/bingo/row/2 slots[5]
