...
execute store success score $item_detect/bingo/row/1/1.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/row/1 icon set from storage temp:bingo.item_detect/bingo/row/1 slots[0]
