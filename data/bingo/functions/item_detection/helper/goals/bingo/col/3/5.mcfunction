...
execute store success score $item_detect/bingo/col/3/5.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/col/3 icon set from storage temp:bingo.item_detect/bingo/col/3 slots[22]
