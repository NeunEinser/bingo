...
execute store success score $item_detect/bingo/col/5/5.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/col/5 icon set from storage bingo:card teams[-1].slots[24]
