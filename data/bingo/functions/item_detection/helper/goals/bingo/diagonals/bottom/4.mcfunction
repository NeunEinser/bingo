...
execute store success score $item_detect/bingo/diagonal/bl/4.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/diagonal/bottom_left icon set from storage bingo:card teams[-1].slots[16]
