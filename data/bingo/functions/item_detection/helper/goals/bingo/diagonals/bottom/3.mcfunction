...
execute store success score $item_detect/bingo/diagonal/bl/3.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/diagonal/bottom_left icon set from storage temp:bingo.item_detect/bingo/diagonal/bottom_left slots[12]
