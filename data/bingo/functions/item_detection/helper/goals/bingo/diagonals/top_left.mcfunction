...
execute store success score $item_detect/bingo/diagonal/tl/1.success bingo.tmp run data modify storage temp:bingo.item_detect/bingo/diagonal/top_left icon set from storage bingo:card teams[-1].slots[0]
