...
execute as @e[type=minecraft:area_effect_cloud, tag=bingo_glistering_melon_slice, scores={bingo_slot_id=0..}, limit=1] run function bingo:award_item/award_item
