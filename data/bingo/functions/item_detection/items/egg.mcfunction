...
execute store success score $item_detect/egg.success bingo.tmp if data storage bingo:card slots[{item:{id:"bingo:egg"}}] run data modify storage bingo:card slots[{item:{id:"bingo:egg"}}].selected set value true
