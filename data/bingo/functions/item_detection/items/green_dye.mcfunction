...
execute store success score $item_detect/green_dye.success bingo.tmp if data storage bingo:card slots[{item:{id:"bingo:green_dye"}}] run data modify storage bingo:card slots[{item:{id:"bingo:green_dye"}}].selected set value true
