...
execute store success score $item_detect/mushroom_stew.success bingo.tmp if data storage bingo:card slots[{item:{id:"bingo:mushroom_stew"}}] run data modify storage bingo:card slots[{item:{id:"bingo:mushroom_stew"}}].selected set value true
