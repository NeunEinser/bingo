...
execute store success score $item_detect/golden_sword.success bingo.tmp run data modify storage temp:bingo.input/item_detection slot set from storage bingo:card slots[{item:{id:"bingo:golden_sword"}}]
