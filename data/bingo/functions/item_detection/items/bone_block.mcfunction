...
execute store success score $item_detect/bone_block.success bingo.tmp if data storage bingo:card slots[{item:{id:"bingo:bone_block"}}] run data modify storage bingo:card slots[{item:{id:"bingo:bone_block"}}].selected set value true
