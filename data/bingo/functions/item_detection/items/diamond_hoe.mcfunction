...
execute store success score $item_detect/diamond_hoe.success bingo.tmp run data modify storage temp:bingo.input/item_detection slot set from storage bingo:card slots[{item:{id:"bingo:diamond_hoe"}}]
