...
execute store success score $item_detect/bingo/row/4/2.success bingo.tmp run data modify storage tmp.bingo:item_detect/bingo/row/4 icon set from storage bingo:card teams[-1].slots[16]
