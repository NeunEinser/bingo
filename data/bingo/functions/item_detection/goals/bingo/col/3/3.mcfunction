...
execute store success score $item_detect/bingo/col/3/3.success bingo.tmp run data modify storage tmp.bingo:item_detect/bingo/col/3 icon set from storage bingo:card teams[-1].slots[12]
