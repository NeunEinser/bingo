...
execute store success score $item_detect/bingo/col/5/2.success bingo.tmp run data modify storage tmp.bingo:item_detect/bingo/col/5 icon set from storage bingo:card teams[-1].slots[9]
