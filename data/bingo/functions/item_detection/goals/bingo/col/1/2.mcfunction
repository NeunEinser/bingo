...
execute store success score $item_detect/bingo/col/1/2.success bingo.tmp run data modify storage tmp.bingo:item_detect/bingo/col/1 icon set from storage bingo:card teams[-1].slots[5]
