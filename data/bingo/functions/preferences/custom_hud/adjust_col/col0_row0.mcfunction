...
execute if score @s bingo.pref matches 44 run data modify storage tmp.bingo:preferences/hud toBeAdded set from storage bingo:custom_hud currentPlayer.components[0]
execute if score @s bingo.pref matches 44 run function bingo:preferences/custom_hud/add_to_col1
...
data modify storage bingo:custom_hud currentPlayer.components[4] set value {id: "bingo:empty", padding: '{"translate": "space.91"}'}