...
execute if score @s bingo.pref matches 56..57 run data modify storage bingo:custom_hud currentPlayer.components[11] set value {id: "bingo:blank", padding: '{"translate": "space.91"}'}