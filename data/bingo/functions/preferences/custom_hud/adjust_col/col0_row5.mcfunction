...
execute if score @s bingo.pref matches 33..34 run data modify storage bingo:custom_hud currentPlayer.components[5] set value {id: "bingo:empty", padding: '{"translate": "space.91"}'}