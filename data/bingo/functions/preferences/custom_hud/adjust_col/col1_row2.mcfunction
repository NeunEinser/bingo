...
execute if score @s bingo.pref matches 58 run data modify storage tmp.bingo:preferences/hud swap set from storage bingo:custom_hud currentPlayer.components[7]
execute if score @s bingo.pref matches 58 run data modify storage bingo:custom_hud currentPlayer.components[7] set from storage bingo:custom_hud currentPlayer.components[6]
execute if score @s bingo.pref matches 58 run data modify storage bingo:custom_hud currentPlayer.components[6] set from storage tmp.bingo:preferences/hud swap

execute if score @s bingo.pref matches 59 run data modify storage tmp.bingo:preferences/hud toBeAdded set from storage bingo:custom_hud currentPlayer.components[7]
