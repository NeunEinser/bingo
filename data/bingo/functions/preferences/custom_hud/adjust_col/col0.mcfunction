...
execute if score @s bingo.pref matches 32..34 run function bingo:preferences/custom_hud/adjust_col/col0_row5
execute if score @s bingo.pref matches 35..37 run function bingo:preferences/custom_hud/adjust_col/col0_row4
execute if score @s bingo.pref matches 38..40 run function bingo:preferences/custom_hud/adjust_col/col0_row3
execute if score @s bingo.pref matches 41..43 run function bingo:preferences/custom_hud/adjust_col/col0_row2
execute if score @s bingo.pref matches 44..46 run function bingo:preferences/custom_hud/adjust_col/col0_row1
execute if score @s bingo.pref matches 47..48 run function bingo:preferences/custom_hud/adjust_col/col0_row0
