...
execute if score $preferences/hud/add.row bingo.tmp matches 0 run data modify storage bingo:custom_hud currentPlayer.components[0] set from storage tmp.bingo:preferences/hud toBeAdded
execute if score $preferences/hud/add.row bingo.tmp matches 1 run data modify storage bingo:custom_hud currentPlayer.components[1] set from storage tmp.bingo:preferences/hud toBeAdded
