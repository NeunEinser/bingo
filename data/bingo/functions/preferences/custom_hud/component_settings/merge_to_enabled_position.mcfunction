...
execute if score $hud/settings/merge_chunk_coord.slot bingo.tmp matches 0..4 run data modify storage bingo:custom_hud currentPlayer.components[4] set value {id: "bingo:empty", slot_id: 4b}
...
execute if score $hud/settings/merge_chunk_coord.slot bingo.tmp matches 5..10 run data modify storage bingo:custom_hud currentPlayer.components[10] set value {id: "bingo:empty", slot_id: 10b}
