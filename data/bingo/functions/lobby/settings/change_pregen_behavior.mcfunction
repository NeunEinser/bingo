...
execute if score $automatically_pregen bingo.settings matches 0 run tellraw @s ["[", {"translate": "bingo.lobby.settings.pregen_behavior.turn_on", "color": "#00c3ff", "clickEvent": {"action": "run_command", "value": "/trigger bingo.settings set 21"}}, "]"]
execute if score $automatically_pregen bingo.settings matches 1 run tellraw @s ["[", {"translate": "bingo.lobby.settings.pregen_behavior.turn_off", "color": "#00c3ff", "clickEvent": {"action": "run_command", "value": "/trigger bingo.settings set 22"}}, "]"]