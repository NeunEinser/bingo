...
#>
# @private
#declare tag bingo.sign_card_generation_furnance
#>
# @private
...
# Card Generation
execute at @e[type=minecraft:area_effect_cloud, tag=bingo.sign_card_generation_furnance, limit=1] run setblock ~ ~ ~ minecraft:warped_wall_sign[facing=south]{Text1: '{"translate":"bingo.lobby.card_generation.furnance.sign.line1", "bold":true, "color":"#8eedeb"}', Text2:'{"translate":"bingo.lobby.card_generation.furnance.sign.line2", "bold":true, "color":"#8eedeb"}', Text3:'{"translate":"bingo.lobby.card_generation.furnance.sign.line3", "bold":true, "color":"#8eedeb"}', Text4:'{"translate":"bingo.lobby.card_generation.furnance.sign.line4", "bold":true, "color":"#8eedeb"}'}
