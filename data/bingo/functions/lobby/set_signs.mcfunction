...
execute at @e[type=minecraft:area_effect_cloud, tag=bingo.sign_credits_gothfaerie, limit=1] run setblock ~ ~ ~ minecraft:warped_wall_sign[facing=north]{Text2: '{"text":"gothfaerie", "bold":true, "color":"#8eedeb", "clickEvent": {"action": "run_command", "value": "/tellraw @s [\\"[\\", {\\"text\\":\\"Twitter/gothfaerie01\\", \\"color\\": \\"#00acee\\", \\"clickEvent\\": {\\"action\\":\\"open_url\\", \\"value\\": \\"https://twitter.com/gothfaerie01\\"}}, \\"]\\\\n\\", \\"[\\", {\\"text\\":\\"Twitch/gothfaerie\\", \\"color\\": \\"#6441a5\\", \\"clickEvent\\": {\\"action\\":\\"open_url\\", \\"value\\": \\"https://www.twitch.tv/gothfaerie\\"}}, \\"]\\"]"}}'}
...
execute at @e[type=minecraft:area_effect_cloud, tag=bingo.sign_settings_more_coming, limit=1] run setblock ~ ~ ~ minecraft:warped_wall_sign[facing=south]{Text2: '{"translate":"More Settings", "bold":true, "color":"#8eedeb", "clickEvent":{"action":"run_command", "value": "/tellraw @s [{\\"translate\\": \\"bingo.lobby.settings.more_coming.menu.title\\"}, {\\"translate\\": \\"bingo.lobby.settings.more_coming.menu.yes\\", \\"color\\": \\"green\\", \\"clickEvent\\": {\\"action\\": \\"run_command\\", \\"value\\": \\"/tellraw @s {\\\\\\"text\\\\\\":\\\\\\"Error accessing the future. Please talk to your local time machine operator.\\\\\\", \\\\\\"obfuscated\\\\\\": true}\\"}}, {\\"translate\\": \\"bingo.lobby.settings.more_coming.menu.no\\", \\"color\\": \\"red\\", \\"clickEvent\\": {\\"action\\": \\"run_command\\", \\"value\\": \\"/tellraw @s {\\\\\\"translate\\\\\\":\\\\\\"bingo.lobby.settings.more_coming.menu.no_text\\\\\\"}\\"}}]"}}', Text3:'{"text":"Coming Soon", "bold":true, "color":"#8eedeb"}'}
