...
execute unless data storage tmp.bingo:chest_generation mergeSort.odd[0] run function bingo:lobby/chest_generation/sort_items/merge_sort_odd
execute if data storage tmp.bingo:chest_generation mergeSort.odd[0] if data storage tmp.bingo:chest_generation mergeSort.even[0] run function bingo:lobby/chest_generation/sort_items/merge_sort_even