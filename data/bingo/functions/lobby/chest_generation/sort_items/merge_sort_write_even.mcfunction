...
execute store result score $chest_generation/sort.a bingo.tmp run data get storage temp:bingo.chest_generation mergeSort.odd[-1][-1].weight
execute store result score $chest_generation/sort.b bingo.tmp run data get storage temp:bingo.chest_generation mergeSort.odd[-2][-1].weight
...
execute if data storage temp:bingo.chest_generation mergeSort.odd[-1][0] if data storage temp:bingo.chest_generation mergeSort.odd[-2][0] run function bingo:lobby/chest_generation/sort_items/merge_sort_write_even