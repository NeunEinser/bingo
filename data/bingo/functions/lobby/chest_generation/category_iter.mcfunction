...
data modify storage tmp.bingo:chest_generation category set from storage tmp.bingo:chest_generation categories[-1]
...
execute store result score $chest_generation/sort/card.size bingo.tmp run data get storage tmp.bingo:chest_generation category.items
...
data modify storage tmp.bingo:chest_generation items set from storage tmp.bingo:chest_generation mergeSort.odd[0]

function bingo:lobby/chest_generation/items_iter

execute if data storage tmp.bingo:chest_generation categories[-1] run function bingo:lobby/chest_generation/category_iter