...
execute if score $chest_generation.row bingo.tmp matches ..2 if score $chest_generation.column bingo.tmp matches ..8 run data modify block ~1 ~ ~ Items append from storage temp:bingo.chest_generation item.item
...
execute if score $chest_generation.column bingo.tmp matches 9.. run data modify block ~ ~ ~ Items append from storage temp:bingo.chest_generation item.item
...
execute if block ~ ~ ~ minecraft:chest[type=single] if data storage temp:bingo.chest_generation items[-1] if score $chest_generation.row bingo.tmp matches 2 run function bingo:lobby/chest_generation/increment_column
