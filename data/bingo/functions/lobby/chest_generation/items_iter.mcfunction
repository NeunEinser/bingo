...
execute if score $chest_generation.row bingo.tmp matches ..2 run data modify block ~ ~ ~ Items append from storage temp:bingo.chest_generation item.item
execute if score $chest_generation.row bingo.tmp matches 3.. run data modify block ~-1 ~ ~ Items append from storage temp:bingo.chest_generation item.item
