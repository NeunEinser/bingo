...
execute if data storage tmp.bingo:chest_generation mergeSort.odd[-1][0] run function bingo:lobby/chest_generation/sort_categories/merge_sort_write_tail_even