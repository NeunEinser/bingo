...
execute if data storage tmp.bingo:chest_generation categories[-2] run function bingo:lobby/chest_generation/sort_categories/write_in_order_odd
execute unless data storage tmp.bingo:chest_generation categories[-2] run function bingo:lobby/chest_generation/sort_categories/write_single_odd
