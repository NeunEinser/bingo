...
execute unless data storage temp:bingo.chest_generation categories[-2] run function bingo:lobby/chest_generation/sort_categories/write_single
...
execute unless data storage temp:bingo.chest_generation categories[0] run function bingo:lobby/chest_generation/sort_categories/merge_sort_even
execute if data storage temp:bingo.chest_generation categories[0] run function bingo:lobby/chest_generation/sort_categories/sort_by_length_odd