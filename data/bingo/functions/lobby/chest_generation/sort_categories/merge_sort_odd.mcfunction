...
execute unless data storage temp:bingo.chest_generation mergeSort.even[0] if data storage temp:bingo.chest_generation mergeSort.odd[1] run function bingo:lobby/chest_generation/sort_categories/merge_sort_even
execute if data storage temp:bingo.chest_generation mergeSort.even[0] if data storage temp:bingo.chest_generation mergeSort.odd[0] run function bingo:lobby/chest_generation/sort_categories/merge_sort_odd