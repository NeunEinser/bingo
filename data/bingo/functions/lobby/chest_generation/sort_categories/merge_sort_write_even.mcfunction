...
execute store result score $chest_generation/sort.a bingo.tmp run data get storage tmp.bingo:chest_generation mergeSort.odd[-1][-1].items
execute store result score $chest_generation/sort.b bingo.tmp run data get storage tmp.bingo:chest_generation mergeSort.odd[-2][-1].items
...
execute if data storage tmp.bingo:chest_generation mergeSort.odd[-1][0] if data storage tmp.bingo:chest_generation mergeSort.odd[-2][0] run function bingo:lobby/chest_generation/sort_categories/merge_sort_write_even