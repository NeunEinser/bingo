...
execute if data storage temp:bingo.chest_generation mergeSort.even[-1][0] run function bingo:lobby/chest_generation/sort_categories/merge_sort_write_tail_odd