...
scoreboard players add @a[scores={bingo.schedule=1..5}] bingo.schedule 1

execute if entity @a[scores={bingo.schedule=1..5}, limit=1] run schedule function bingo:lobby/player_settings/tutorial_text 7s