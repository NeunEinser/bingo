...
data modify storage bingo:registries hud_components append value {id: "bingo:seed", addByDefault: true, preferredColumn: 1, name: '{"translate": "bingo.custom_hud.components.seed"}', iconWidth: '{"translate": "space.9"}', iconSeperator: '" "', iconFont: ['{"text":"", "font": "bingo:seed/line0"}', '{"text":"", "font": "bingo:seed/line1"}', '{"text":"", "font": "bingo:seed/line2"}', '{"text":"", "font": "bingo:seed/line3"}', '{"text":"", "font": "bingo:seed/line4"}', '{"text":"", "font": "bingo:seed/line5"}', '{"text":"", "font": "bingo:seed/line6"}', '{"text":"", "font": "bingo:seed/line7"}', '{"text":"", "font": "bingo:seed/line8"}', '{"text":"", "font": "bingo:seed/line9"}', '{"text":"", "font": "bingo:seed/line10"}'], icon:'"s"'}
