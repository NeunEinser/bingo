...
data modify storage bingo:registries categories append value {name: "bingo:clay", translatableName: '{"translate": "bingo.category.clay"}', tags: ["bingo:default"]}
...
data modify storage bingo:registries categories append value {name: "bingo:skeleton_drops", translatableName: '{"translate": "bingo.category.skeleton_drops"}', tags: ["bingo:default"]}
