...
data modify storage bingo:registries hud_components append value {id: "bingo:player_position", addByDefault: true, preferredColumn: 1, name: '{"translate": "bingo.custom_hud.components.player_position"}', iconWidth: '{"translate": "space.10"}', iconSeperator: '" "', iconFont: ['{"text":"", "font": "bingo:compass/line0"}', '{"text":"", "font": "bingo:compass/line1"}', '{"text":"", "font": "bingo:compass/line2"}', '{"text":"", "font": "bingo:compass/line3"}', '{"text":"", "font": "bingo:compass/line4"}', '{"text":"", "font": "bingo:compass/line5"}', '{"text":"", "font": "bingo:compass/line6"}', '{"text":"", "font": "bingo:compass/line7"}', '{"text":"", "font": "bingo:compass/line8"}', '{"text":"", "font": "bingo:compass/line9"}', '{"text":"", "font": "bingo:compass/line10"}']}
