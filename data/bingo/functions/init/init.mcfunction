...
data modify storage bingo:items categories[{name:"bingo:pumpkin"}].items append from storage temp:bingo.init item

## 0002: pumpkin_pie
data modify storage temp:bingo.init item set value {id: "bingo:pumpkin_pie", item: {id: "minecraft:pumpkin_pie"}, textComponent: '{"translate": "item.minecraft.pumpkin_pie", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:pumpkin_pie"}}}', icon: '"\\u0002"', clearCommand: "clear @a[tag=bingo.clear] minecraft:pumpkin_pie 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:pumpkin"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:egg"}].items append from storage temp:bingo.init item

## 0003: egg
data modify storage temp:bingo.init item set value {id: "bingo:egg", item: {id: "minecraft:egg"}, textComponent: '{"translate": "item.minecraft.egg", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:egg"}}}', icon: '"\\u0003"', clearCommand: "clear @a[tag=bingo.clear] minecraft:egg 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:egg"}].items append from storage temp:bingo.init item

## 0004: cake
data modify storage temp:bingo.init item set value {id: "bingo:cake", item: {id: "minecraft:cake"}, textComponent: '{"translate": "block.minecraft.cake", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cake"}}}', icon: '"\\u0004"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cake 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:egg"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:milk"}].items append from storage temp:bingo.init item
...
data modify storage bingo:items categories[{name:"bingo:sapling"}].items append from storage temp:bingo.init item

## 0006: spruce_sapling
data modify storage temp:bingo.init item set value {id: "bingo:spruce_sapling", item: {id: "minecraft:spruce_sapling"}, textComponent: '{"translate": "block.minecraft.spruce_sapling", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:spruce_sapling"}}}', icon: '"\\u0006"', clearCommand: "clear @a[tag=bingo.clear] minecraft:spruce_sapling 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:sapling"}].items append from storage temp:bingo.init item
...
## 0008: cookie
data modify storage temp:bingo.init item set value {id: "bingo:cookie", item: {id: "minecraft:cookie"}, textComponent: '{"translate": "item.minecraft.cookie", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cookie"}}}', icon: '"\\u0008"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cookie 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:jungle"}].items append from storage temp:bingo.init item

## 0009: melon_slice
data modify storage temp:bingo.init item set value {id: "bingo:melon_slice", item: {id: "minecraft:melon_slice"}, textComponent: '{"translate": "item.minecraft.melon_slice", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:melon_slice"}}}', icon: '"\\u0009"', clearCommand: "clear @a[tag=bingo.clear] minecraft:melon_slice 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:jungle"}].items append from storage temp:bingo.init item

## 000a: glistering_melon_slice
data modify storage temp:bingo.init item set value {id: "bingo:glistering_melon_slice", item: {id: "minecraft:glistering_melon_slice"}, textComponent: '{"translate": "item.minecraft.glistering_melon_slice", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:glistering_melon_slice"}}}', icon: '"\\u000a"', clearCommand: "clear @a[tag=bingo.clear] minecraft:glistering_melon_slice 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:jungle"}].items append from storage temp:bingo.init item

## 000b: dead_bush
data modify storage temp:bingo.init item set value {id: "bingo:dead_bush", item: {id: "minecraft:dead_bush"}, textComponent: '{"translate": "block.minecraft.dead_bush", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dead_bush"}}}', icon: '"\\u000b"', clearCommand: "clear @a[tag=bingo.clear] minecraft:dead_bush 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:shearable"}].items append from storage temp:bingo.init item

## 000c: fern
data modify storage temp:bingo.init item set value {id: "bingo:fern", item: {id: "minecraft:fern"}, textComponent: '{"translate": "block.minecraft.fern", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:fern"}}}', icon: '"\\u000c"', clearCommand: "clear @a[tag=bingo.clear] minecraft:fern 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:shearable"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:taiga"}].items append from storage temp:bingo.init item

## 000d: vine
data modify storage temp:bingo.init item set value {id: "bingo:vine", item: {id: "minecraft:vine"}, textComponent: '{"translate": "block.minecraft.vine", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:vine"}}}', icon: '"\\u000d"', clearCommand: "clear @a[tag=bingo.clear] minecraft:vine 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:shearable"}].items append from storage temp:bingo.init item

## 000e: rail
data modify storage temp:bingo.init item set value {id: "bingo:rail", item: {id: "minecraft:rail"}, textComponent: '{"translate": "block.minecraft.rail", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:rail"}}}', icon: '"\\u000e"', clearCommand: "clear @a[tag=bingo.clear] minecraft:rail 1", categories: 1, weight: 1}
...
## 0010: flint
data modify storage temp:bingo.init item set value {id: "bingo:flint", item: {id: "minecraft:flint"}, textComponent: '{"translate": "item.minecraft.flint", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flint"}}}', icon: '"\\u0010"', clearCommand: "clear @a[tag=bingo.clear] minecraft:flint 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:flint"}].items append from storage temp:bingo.init item

## 0011: flint_and_steel
data modify storage temp:bingo.init item set value {id: "bingo:flint_and_steel", item: {id: "minecraft:flint_and_steel"}, textComponent: '{"translate": "item.minecraft.flint_and_steel", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flint_and_steel"}}}', icon: '"\\u0011"', clearCommand: "clear @a[tag=bingo.clear] minecraft:flint_and_steel 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:flint"}].items append from storage temp:bingo.init item

## 0012: arrow
data modify storage temp:bingo.init item set value {id: "bingo:arrow", item: {id: "minecraft:arrow"}, textComponent: '{"translate": "item.minecraft.arrow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:arrow"}}}', icon: '"\\u0012"', clearCommand: "clear @a[tag=bingo.clear] minecraft:arrow 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:flint"}].items append from storage temp:bingo.init item
...
## 0014: slime_ball
data modify storage temp:bingo.init item set value {id: "bingo:slime_ball", item: {id: "minecraft:slime_ball"}, textComponent: '{"translate": "item.minecraft.slime_ball", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:slime_ball"}}}', icon: '"\\u0014"', clearCommand: "clear @a[tag=bingo.clear] minecraft:slime_ball 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:enderslime"}].items append from storage temp:bingo.init item

## 0015: firework_rocket
data modify storage temp:bingo.init item set value {id: "bingo:firework_rocket", item: {id: "minecraft:firework_rocket"}, textComponent: '{"translate": "item.minecraft.firework_rocket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:firework_rocket"}}}', icon: '"\\u0015"', clearCommand: "clear @a[tag=bingo.clear] minecraft:firework_rocket 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gunpowder"}].items append from storage temp:bingo.init item

## 0016: milk_bucket
data modify storage temp:bingo.init item set value {id: "bingo:milk_bucket", item: {id: "minecraft:milk_bucket"}, textComponent: '{"translate": "item.minecraft.milk_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:milk_bucket"}}}', icon: '"\\u0016"', clearCommand: "clear @a[tag=bingo.clear] minecraft:milk_bucket 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:milk"}].items append from storage temp:bingo.init item

## 0017: cauldron
data modify storage temp:bingo.init item set value {id: "bingo:cauldron", item: {id: "minecraft:cauldron"}, textComponent: '{"translate": "block.minecraft.cauldron", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cauldron"}}}', icon: '"\\u0017"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cauldron 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:simple_iron"}].items append from storage temp:bingo.init item

## 0018: saddle
data modify storage temp:bingo.init item set value {id: "bingo:saddle", item: {id: "minecraft:saddle"}, textComponent: '{"translate": "item.minecraft.saddle", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:saddle"}}}', icon: '"\\u0018"', clearCommand: "clear @a[tag=bingo.clear] minecraft:saddle 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:chest_loot"}].items append from storage temp:bingo.init item

## 0019: name_tag
data modify storage temp:bingo.init item set value {id: "bingo:name_tag", item: {id: "minecraft:name_tag"}, textComponent: '{"translate": "item.minecraft.name_tag", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:name_tag"}}}', icon: '"\\u0019"', clearCommand: "clear @a[tag=bingo.clear] minecraft:name_tag 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:chest_loot"}].items append from storage temp:bingo.init item

## 001a: painting
data modify storage temp:bingo.init item set value {id: "bingo:painting", item: {id: "minecraft:painting"}, textComponent: '{"translate": "item.minecraft.painting", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:painting"}}}', icon: '"\\u001a"', clearCommand: "clear @a[tag=bingo.clear] minecraft:painting 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:wool"}].items append from storage temp:bingo.init item

## 001b: item_frame
data modify storage temp:bingo.init item set value {id: "bingo:item_frame", item: {id: "minecraft:item_frame"}, textComponent: '{"translate": "item.minecraft.item_frame", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:item_frame"}}}', icon: '"\\u001b"', clearCommand: "clear @a[tag=bingo.clear] minecraft:item_frame 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:leather"}].items append from storage temp:bingo.init item

## 001c: emerald
data modify storage temp:bingo.init item set value {id: "bingo:emerald", item: {id: "minecraft:emerald"}, textComponent: '{"translate": "item.minecraft.emerald", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:emerald"}}}', icon: '"\\u001c"', clearCommand: "clear @a[tag=bingo.clear] minecraft:emerald 1", categories: 1, weight: 1}
...
## 0021: flower_pot
data modify storage temp:bingo.init item set value {id: "bingo:flower_pot", item: {id: "minecraft:flower_pot"}, textComponent: '{"translate": "block.minecraft.flower_pot", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flower_pot"}}}', icon: '"\\u0021"', clearCommand: "clear @a[tag=bingo.clear] minecraft:flower_pot 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:brick"}].items append from storage temp:bingo.init item

## 0022: brick
data modify storage temp:bingo.init item set value {id: "bingo:brick", item: {id: "minecraft:brick"}, textComponent: '{"translate": "item.minecraft.brick", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:brick"}}}', icon: '"\\u0022"', clearCommand: "clear @a[tag=bingo.clear] minecraft:brick 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:brick"}].items append from storage temp:bingo.init item

## 0023: mushroom_stew
data modify storage temp:bingo.init item set value {id: "bingo:mushroom_stew", item: {id: "minecraft:mushroom_stew"}, textComponent: '{"translate": "item.minecraft.mushroom_stew", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:mushroom_stew"}}}', icon: '"\\u0023"', clearCommand: "clear @a[tag=bingo.clear] minecraft:mushroom_stew 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:mushroom"}].items append from storage temp:bingo.init item

## 0024: beetroot_soup
data modify storage temp:bingo.init item set value {id: "bingo:beetroot_soup", item: {id: "minecraft:beetroot_soup"}, textComponent: '{"translate": "item.minecraft.beetroot_soup", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:beetroot_soup"}}}', icon: '"\\u0024"', clearCommand: "clear @a[tag=bingo.clear] minecraft:beetroot_soup 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:chest_loot"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:village"}].items append from storage temp:bingo.init item

## 0025: apple
data modify storage temp:bingo.init item set value {id: "bingo:apple", item: {id: "minecraft:apple"}, textComponent: '{"translate": "item.minecraft.apple", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:apple"}}}', icon: '"\\u0025"', clearCommand: "clear @a[tag=bingo.clear] minecraft:apple 1", categories: 1, weight: 1}
...
## 0029: clock
data modify storage temp:bingo.init item set value {id: "bingo:clock", item: {id: "minecraft:clock"}, textComponent: '{"translate": "item.minecraft.clock", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:clock"}}}', icon: '"\\u0029"', clearCommand: "clear @a[tag=bingo.clear] minecraft:clock 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gold"}].items append from storage temp:bingo.init item

## 002a: repeater
data modify storage temp:bingo.init item set value {id: "bingo:repeater", item: {id: "minecraft:repeater"}, textComponent: '{"translate": "block.minecraft.repeater", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:repeater"}}}', icon: '"\\u002a"', clearCommand: "clear @a[tag=bingo.clear] minecraft:repeater 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:redstone"}].items append from storage temp:bingo.init item

## 002b: compass
data modify storage temp:bingo.init item set value {id: "bingo:compass", item: {id: "minecraft:compass"}, textComponent: '{"translate": "item.minecraft.compass", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:compass"}}}', icon: '"\\u002b"', clearCommand: "clear @a[tag=bingo.clear] minecraft:compass 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:compass"}].items append from storage temp:bingo.init item

## 002c: map
data modify storage temp:bingo.init item set value {id: "bingo:map", item: {id: "minecraft:map"}, textComponent: '{"translate": "item.minecraft.map", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:map"}}}', icon: '"\\u002c"', clearCommand: "clear @a[tag=bingo.clear] minecraft:map 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:compass"}].items append from storage temp:bingo.init item

## 002d: book
data modify storage temp:bingo.init item set value {id: "bingo:book", item: {id: "minecraft:book"}, textComponent: '{"translate": "item.minecraft.book", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:book"}}}', icon: '"\\u002d"', clearCommand: "clear @a[tag=bingo.clear] minecraft:book 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:leather"}].items append from storage temp:bingo.init item

## 002e: writable_book
data modify storage temp:bingo.init item set value {id: "bingo:writable_book", item: {id: "minecraft:writable_book"}, textComponent: '{"translate": "item.minecraft.writable_book", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:writable_book"}}}', icon: '"\\u002e"', clearCommand: "clear @a[tag=bingo.clear] minecraft:writable_book 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:leather"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:ink"}].items append from storage temp:bingo.init item
...
## 0030: spider_eye
data modify storage temp:bingo.init item set value {id: "bingo:spider_eye", item: {id: "minecraft:spider_eye"}, textComponent: '{"translate": "item.minecraft.spider_eye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:spider_eye"}}}', icon: '"\\u0030"', clearCommand: "clear @a[tag=bingo.clear] minecraft:spider_eye 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:spider"}].items append from storage temp:bingo.init item

## 0031: fermented_spider_eye
data modify storage temp:bingo.init item set value {id: "bingo:fermented_spider_eye", item: {id: "minecraft:fermented_spider_eye"}, textComponent: '{"translate": "item.minecraft.fermented_spider_eye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:fermented_spider_eye"}}}', icon: '"\\u0031"', clearCommand: "clear @a[tag=bingo.clear] minecraft:fermented_spider_eye 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:spider"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:mushroom"}].items append from storage temp:bingo.init item

## 0032: gunpowder
data modify storage temp:bingo.init item set value {id: "bingo:gunpowder", item: {id: "minecraft:gunpowder"}, textComponent: '{"translate": "item.minecraft.gunpowder", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:gunpowder"}}}', icon: '"\\u0032"', clearCommand: "clear @a[tag=bingo.clear] minecraft:gunpowder 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gunpowder"}].items append from storage temp:bingo.init item

## 0033: tnt_minecart
data modify storage temp:bingo.init item set value {id: "bingo:tnt_minecart", item: {id: "minecraft:tnt_minecart"}, textComponent: '{"translate": "item.minecraft.tnt_minecart", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:tnt_minecart"}}}', icon: '"\\u0033"', clearCommand: "clear @a[tag=bingo.clear] minecraft:tnt_minecart 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gunpowder"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:sand"}].items append from storage temp:bingo.init item

## 0034: hopper
data modify storage temp:bingo.init item set value {id: "bingo:hopper", item: {id: "minecraft:hopper"}, textComponent: '{"translate": "block.minecraft.hopper", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hopper"}}}', icon: '"\\u0034"', clearCommand: "clear @a[tag=bingo.clear] minecraft:hopper 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:chest_iron"}].items append from storage temp:bingo.init item

## 0035: hopper_minecart
data modify storage temp:bingo.init item set value {id: "bingo:hopper_minecart", item: {id: "minecraft:hopper_minecart"}, textComponent: '{"translate": "item.minecraft.hopper_minecart", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hopper_minecart"}}}', icon: '"\\u0035"', clearCommand: "clear @a[tag=bingo.clear] minecraft:hopper_minecart 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:chest_iron"}].items append from storage temp:bingo.init item
...
data modify storage bingo:items categories[{name:"bingo:furnace_iron"}].items append from storage temp:bingo.init item
...
## 0038: bone
data modify storage temp:bingo.init item set value {id: "bingo:bone", item: {id: "minecraft:bone"}, textComponent: '{"translate": "item.minecraft.bone", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bone"}}}', icon: '"\\u0038"', clearCommand: "clear @a[tag=bingo.clear] minecraft:bone 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:ink_bone"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:cactus_bone"}].items append from storage temp:bingo.init item

## 0039: ink_sac
data modify storage temp:bingo.init item set value {id: "bingo:ink_sac", item: {id: "minecraft:ink_sac"}, textComponent: '{"translate": "item.minecraft.ink_sac", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:ink_sac"}}}', icon: '"\\u0039"', clearCommand: "clear @a[tag=bingo.clear] minecraft:ink_sac 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:ink"}].items append from storage temp:bingo.init item

## 003a: gray_dye
data modify storage temp:bingo.init item set value {id: "bingo:gray_dye", item: {id: "minecraft:gray_dye"}, textComponent: '{"translate": "item.minecraft.gray_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:gray_dye"}}}', icon: '"\\u003a"', clearCommand: "clear @a[tag=bingo.clear] minecraft:gray_dye 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:ink"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:ink_bone"}].items append from storage temp:bingo.init item

## 003b: green_dye
data modify storage temp:bingo.init item set value {id: "bingo:green_dye", item: {id: "minecraft:green_dye"}, textComponent: '{"translate": "item.minecraft.green_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:green_dye"}}}', icon: '"\\u003b"', clearCommand: "clear @a[tag=bingo.clear] minecraft:green_dye 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:cactus"}].items append from storage temp:bingo.init item

## 003c: lime_dye
data modify storage temp:bingo.init item set value {id: "bingo:lime_dye", item: {id: "minecraft:lime_dye"}, textComponent: '{"translate": "item.minecraft.lime_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lime_dye"}}}', icon: '"\\u003c"', clearCommand: "clear @a[tag=bingo.clear] minecraft:lime_dye 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:cactus"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:cactus_bone"}].items append from storage temp:bingo.init item
...
data modify storage bingo:items categories[{name:"bingo:lapis"}].items append from storage temp:bingo.init item

## 003e: cyan_dye
data modify storage temp:bingo.init item set value {id: "bingo:cyan_dye", item: {id: "minecraft:cyan_dye"}, textComponent: '{"translate": "item.minecraft.cyan_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cyan_dye"}}}', icon: '"\\u003e"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cyan_dye 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:lapis"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:cactus"}].items append from storage temp:bingo.init item

## 003f: purple_dye
data modify storage temp:bingo.init item set value {id: "bingo:purple_dye", item: {id: "minecraft:purple_dye"}, textComponent: '{"translate": "item.minecraft.purple_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:purple_dye"}}}', icon: '"\\u003f"', clearCommand: "clear @a[tag=bingo.clear] minecraft:purple_dye 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:lapis"}].items append from storage temp:bingo.init item

## 0040: suspicious_stew
data modify storage temp:bingo.init item set value {id: "bingo:suspicious_stew", item: {id: "minecraft:suspicious_stew"}, textComponent: '{"translate": "item.minecraft.suspicious_stew", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:suspicious_stew"}}}', icon: '"\\u0040"', clearCommand: "clear @a[tag=bingo.clear] minecraft:suspicious_stew 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:mushroom"}].items append from storage temp:bingo.init item
...
## 0042: cod
data modify storage temp:bingo.init item set value {id: "bingo:cod", item: {id: "minecraft:cod"}, textComponent: '{"translate": "item.minecraft.cod", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cod"}}}', icon: '"\\u0042"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cod 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:fish"}].items append from storage temp:bingo.init item

## 0043: cod_bucket
data modify storage temp:bingo.init item set value {id: "bingo:cod_bucket", item: {id: "minecraft:cod_bucket"}, textComponent: '{"translate": "item.minecraft.cod_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cod_bucket"}}}', icon: '"\\u0043"', clearCommand: "clear @a[tag=bingo.clear] minecraft:cod_bucket 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:fish"}].items append from storage temp:bingo.init item

## 0044: salmon
data modify storage temp:bingo.init item set value {id: "bingo:salmon", item: {id: "minecraft:salmon"}, textComponent: '{"translate": "item.minecraft.salmon", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:salmon"}}}', icon: '"\\u0044"', clearCommand: "clear @a[tag=bingo.clear] minecraft:salmon 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:fish"}].items append from storage temp:bingo.init item

## 0045: salmon_bucket
data modify storage temp:bingo.init item set value {id: "bingo:salmon_bucket", item: {id: "minecraft:salmon_bucket"}, textComponent: '{"translate": "item.minecraft.salmon_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:salmon_bucket"}}}', icon: '"\\u0045"', clearCommand: "clear @a[tag=bingo.clear] minecraft:salmon_bucket 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:fish"}].items append from storage temp:bingo.init item
...
data modify storage temp:bingo.init item set value {id: "bingo:dark_oak_sapling", item: {id: "minecraft:dark_oak_sapling"}, textComponent: '{"translate": "block.minecraft.dark_oak_sapling", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dark_oak_sapling"}}}', icon: '"\\u0049"', clearCommand: "clear @a[tag=bingo.clear] minecraft:dark_oak_sapling 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:sapling"}].items append from storage temp:bingo.init item
...
## 0050: diamond_sword
data modify storage temp:bingo.init item set value {id: "bingo:diamond_sword", item: {id: "minecraft:diamond_sword"}, textComponent: '{"translate": "item.minecraft.diamond_sword", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:diamond_sword"}}}', icon: '"\\u0050"', clearCommand: "clear @a[tag=bingo.clear] minecraft:diamond_sword 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:diamond"}].items append from storage temp:bingo.init item
...
## 0052: golden_axe
data modify storage temp:bingo.init item set value {id: "bingo:golden_axe", item: {id: "minecraft:golden_axe"}, textComponent: '{"translate": "item.minecraft.golden_axe", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_axe"}}}', icon: '"\\u0052"', clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_axe 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gold"}].items append from storage temp:bingo.init item
...
## 0054: golden_hoe
data modify storage temp:bingo.init item set value {id: "bingo:golden_hoe", item: {id: "minecraft:golden_hoe"}, textComponent: '{"translate": "item.minecraft.golden_hoe", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_hoe"}}}', icon: '"\\u0054"', clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_hoe 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gold"}].items append from storage temp:bingo.init item

## 0055: crossbow
data modify storage temp:bingo.init item set value {id: "bingo:crossbow", item: {id: "minecraft:crossbow"}, textComponent: '{"translate": "item.minecraft.crossbow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:crossbow"}}}', icon: '"\\u0055"', clearCommand: "clear @a[tag=bingo.clear] minecraft:crossbow 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:bow"}].items append from storage temp:bingo.init item

## 0056: bamboo
data modify storage temp:bingo.init item set value {id: "bingo:bamboo", item: {id: "minecraft:bamboo"}, textComponent: '{"translate": "block.minecraft.bamboo", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bamboo"}}}', icon: '"\\u0056"', clearCommand: "clear @a[tag=bingo.clear] minecraft:bamboo 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:jungle"}].items append from storage temp:bingo.init item

## 0057: sea_pickle
data modify storage temp:bingo.init item set value {id: "bingo:sea_pickle", item: {id: "minecraft:sea_pickle"}, textComponent: '{"translate": "block.minecraft.sea_pickle", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:sea_pickle"}}}', icon: '"\\u0057"', clearCommand: "clear @a[tag=bingo.clear] minecraft:sea_pickle 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:warm_ocean"}].items append from storage temp:bingo.init item

## 0058: seagrass
data modify storage temp:bingo.init item set value {id: "bingo:seagrass", item: {id: "minecraft:seagrass"}, textComponent: '{"translate": "block.minecraft.seagrass", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:seagrass"}}}', icon: '"\\u0058"', clearCommand: "clear @a[tag=bingo.clear] minecraft:seagrass 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:shearable"}].items append from storage temp:bingo.init item

## 0100: iron_block
data modify storage temp:bingo.init item set value {id: "bingo:iron_block", item: {id: "minecraft:iron_block"}, textComponent: '{"translate": "block.minecraft.iron_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:iron_block"}}}', icon: '"\\u0100"', clearCommand: "clear @a[tag=bingo.clear] minecraft:iron_block 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:simple_iron"}].items append from storage temp:bingo.init item
...
## 0102: bookshelf
data modify storage temp:bingo.init item set value {id: "bingo:bookshelf", item: {id: "minecraft:bookshelf"}, textComponent: '{"translate": "block.minecraft.bookshelf", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bookshelf"}}}', icon: '"\\u0102"', clearCommand: "clear @a[tag=bingo.clear] minecraft:bookshelf 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:leather"}].items append from storage temp:bingo.init item

## 0103: obsidian
data modify storage temp:bingo.init item set value {id: "bingo:obsidian", item: {id: "minecraft:obsidian"}, textComponent: '{"translate": "block.minecraft.obsidian", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:obsidian"}}}', icon: '"\\u0103"', clearCommand: "clear @a[tag=bingo.clear] minecraft:obsidian 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:diamond"}].items append from storage temp:bingo.init item

## 0104: melon
data modify storage temp:bingo.init item set value {id: "bingo:melon", item: {id: "minecraft:melon"}, textComponent: '{"translate": "block.minecraft.melon", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:melon"}}}', icon: '"\\u0104"', clearCommand: "clear @a[tag=bingo.clear] minecraft:melon 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:jungle"}].items append from storage temp:bingo.init item

## 0105: mossy_stone_bricks
data modify storage temp:bingo.init item set value {id: "bingo:mossy_stone_bricks", item: {id: "minecraft:mossy_stone_bricks"}, textComponent: '{"translate": "block.minecraft.mossy_stone_bricks", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:mossy_stone_bricks"}}}', icon: '"\\u0105"', clearCommand: "clear @a[tag=bingo.clear] minecraft:mossy_stone_bricks 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:shearable"}].items append from storage temp:bingo.init item

## 0106: jukebox
data modify storage temp:bingo.init item set value {id: "bingo:jukebox", item: {id: "minecraft:jukebox"}, textComponent: '{"translate": "block.minecraft.jukebox", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:jukebox"}}}', icon: '"\\u0106"', clearCommand: "clear @a[tag=bingo.clear] minecraft:jukebox 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:diamond"}].items append from storage temp:bingo.init item
...
## 0108: bone_block
data modify storage temp:bingo.init item set value {id: "bingo:bone_block", item: {id: "minecraft:bone_block"}, textComponent: '{"translate": "block.minecraft.bone_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bone_block"}}}', icon: '"\\u0108"', clearCommand: "clear @a[tag=bingo.clear] minecraft:bone_block 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:ink_bone"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:cactus_bone"}].items append from storage temp:bingo.init item

## 0109: blast_furnace
data modify storage temp:bingo.init item set value {id: "bingo:blast_furnace", item: {id: "minecraft:blast_furnace"}, textComponent: '{"translate": "block.minecraft.blast_furnace", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:blast_furnace"}}}', icon: '"\\u0109"', clearCommand: "clear @a[tag=bingo.clear] minecraft:blast_furnace 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:furnace_iron"}].items append from storage temp:bingo.init item
...
#data modify storage bingo:items categories[{name:"bingo:ominous_banner"}].items append from storage temp:bingo.init item

## 010b: red_bed
data modify storage temp:bingo.init item set value {id: "bingo:red_bed", item: {id: "minecraft:red_bed"}, textComponent: '{"translate": "block.minecraft.red_bed", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:red_bed"}}}', icon: '"\\u010b"', clearCommand: "clear @a[tag=bingo.clear] minecraft:red_bed 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:wool"}].items append from storage temp:bingo.init item

## 010c: target
data modify storage temp:bingo.init item set value {id: "bingo:target", item: {id: "minecraft:target"}, textComponent: '{"translate": "block.minecraft.target", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:target"}}}', icon: '"\\u010c"', clearCommand: "clear @a[tag=bingo.clear] minecraft:target 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:redstone"}].items append from storage temp:bingo.init item

## 010d: snow
data modify storage temp:bingo.init item set value {id: "bingo:snow", item: {id: "minecraft:snow"}, textComponent: '{"translate": "block.minecraft.snow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:snow"}}}', icon: '"\\u010d"', clearCommand: "clear @a[tag=bingo.clear] minecraft:snow 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:snow"}].items append from storage temp:bingo.init item

## 010e: snow_block
data modify storage temp:bingo.init item set value {id: "bingo:snow_block", item: {id: "minecraft:snow_block"}, textComponent: '{"translate": "block.minecraft.snow_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:snow_block"}}}', icon: '"\\u010e"', clearCommand: "clear @a[tag=bingo.clear] minecraft:snow_block 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:snow"}].items append from storage temp:bingo.init item
...
## 0110: tnt
data modify storage temp:bingo.init item set value {id: "bingo:tnt", item: {id: "minecraft:tnt"}, textComponent: '{"translate": "block.minecraft.tnt", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:tnt"}}}', icon: '"\\u0110"', clearCommand: "clear @a[tag=bingo.clear] minecraft:tnt 1", categories: 2, weight: 1}
data modify storage bingo:items categories[{name:"bingo:gunpowder"}].items append from storage temp:bingo.init item
data modify storage bingo:items categories[{name:"bingo:sand"}].items append from storage temp:bingo.init item

## 0111: lapis_block
data modify storage temp:bingo.init item set value {id: "bingo:lapis_block", item: {id: "minecraft:lapis_block"}, textComponent: '{"translate": "block.minecraft.lapis_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lapis_block"}}}', icon: '"\\u0111"', clearCommand: "clear @a[tag=bingo.clear] minecraft:lapis_block 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:lapis"}].items append from storage temp:bingo.init item

## 0112: dispenser
data modify storage temp:bingo.init item set value {id: "bingo:dispenser", item: {id: "minecraft:dispenser"}, textComponent: '{"translate": "block.minecraft.dispenser", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dispenser"}}}', icon: '"\\u0112"', clearCommand: "clear @a[tag=bingo.clear] minecraft:dispenser 1", categories: 1, weight: 1}
data modify storage bingo:items categories[{name:"bingo:bow"}].items append from storage temp:bingo.init item