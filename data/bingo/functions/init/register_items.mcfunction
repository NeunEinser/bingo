...
## 115: hay_bale
data modify storage bingo:items registry append value {id: "bingo:hay_bale", item: {id: "minecraft:hay_block"}, textComponent: '{"translate": "block.minecraft.hay_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hay_bale"}}}', icon: '"\\u0115"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:hay_bale 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:hay_bale 1", categories: ["bingo:wheat"], weight: 1}
