...
## 0002: pumpkin_pie
data modify storage bingo:items registry append value {id: "bingo:pumpkin_pie", item: {id: "minecraft:pumpkin_pie"}, textComponent: '{"translate": "item.minecraft.pumpkin_pie", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:pumpkin_pie"}}}', icon: '"\\u0002"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:pumpkin_pie 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:pumpkin_pie 1", categories: ["bingo:pumpkin", "bingo:egg"], weight: 1}

## 0003: egg
data modify storage bingo:items registry append value {id: "bingo:egg", item: {id: "minecraft:egg"}, textComponent: '{"translate": "item.minecraft.egg", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:egg"}}}', icon: '"\\u0003"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:egg 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:egg 1", categories: ["bingo:egg"], weight: 1}

## 0004: cake
data modify storage bingo:items registry append value {id: "bingo:cake", item: {id: "minecraft:cake"}, textComponent: '{"translate": "block.minecraft.cake", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cake"}}}', icon: '"\\u0004"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:cake 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:cake 1", categories: ["bingo:egg", "bingo:milk", "bingo:wheat"], weight: 1}
...
## 0006: spruce_sapling
data modify storage bingo:items registry append value {id: "bingo:spruce_sapling", item: {id: "minecraft:spruce_sapling"}, textComponent: '{"translate": "block.minecraft.spruce_sapling", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:spruce_sapling"}}}', icon: '"\\u0006"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:spruce_sapling 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:spruce_sapling 1", categories: ["bingo:sapling"], weight: 1}
...
## 0008: cookie
data modify storage bingo:items registry append value {id: "bingo:cookie", item: {id: "minecraft:cookie"}, textComponent: '{"translate": "item.minecraft.cookie", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cookie"}}}', icon: '"\\u0008"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:cookie 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:cookie 1", categories: ["bingo:jungle"], weight: 1}

## 0009: melon_slice
data modify storage bingo:items registry append value {id: "bingo:melon_slice", item: {id: "minecraft:melon_slice"}, textComponent: '{"translate": "item.minecraft.melon_slice", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:melon_slice"}}}', icon: '"\\u0009"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:melon_slice 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:melon_slice 1", categories: ["bingo:jungle"], weight: 1}
...
## 000c: fern
data modify storage bingo:items registry append value {id: "bingo:fern", item: {id: "minecraft:fern"}, textComponent: '{"translate": "block.minecraft.fern", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:fern"}}}', icon: '"\\u000c"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:fern 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:fern 1", categories: ["bingo:shearable", "bingo:taiga"], weight: 1}
...
## 000e: rail
data modify storage bingo:items registry append value {id: "bingo:rail", item: {id: "minecraft:rail"}, textComponent: '{"translate": "block.minecraft.rail", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:rail"}}}', icon: '"\\u000e"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:rail 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:rail 1", categories: ["bingo:rail"], weight: 1}

## 000f: powered_rail
data modify storage bingo:items registry append value {id: "bingo:powered_rail", item: {id: "minecraft:powered_rail"}, textComponent: '{"translate": "block.minecraft.powered_rail", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:powered_rail"}}}', icon: '"\\u000f"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:powered_rail 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:powered_rail 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0010: flint
data modify storage bingo:items registry append value {id: "bingo:flint", item: {id: "minecraft:flint"}, textComponent: '{"translate": "item.minecraft.flint", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flint"}}}', icon: '"\\u0010"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:flint 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:flint 1", categories: ["bingo:flint"], weight: 1}

## 0011: flint_and_steel
data modify storage bingo:items registry append value {id: "bingo:flint_and_steel", item: {id: "minecraft:flint_and_steel"}, textComponent: '{"translate": "item.minecraft.flint_and_steel", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flint_and_steel"}}}', icon: '"\\u0011"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:flint_and_steel 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:flint_and_steel 1", categories: ["bingo:flint"], weight: 1}

## 0012: arrow
data modify storage bingo:items registry append value {id: "bingo:arrow", item: {id: "minecraft:arrow"}, textComponent: '{"translate": "item.minecraft.arrow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:arrow"}}}', icon: '"\\u0012"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:arrow 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:arrow 1", categories: ["bingo:flint"], weight: 1}
...
data modify storage bingo:items registry append value {id: "bingo:firework_rocket", item: {id: "minecraft:firework_rocket"}, textComponent: '{"translate": "item.minecraft.firework_rocket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:firework_rocket"}}}', icon: '"\\u0015"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:firework_rocket 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:firework_rocket 1", categories: ["bingo:gunpowder"], weight: 1}

## 0016: milk_bucket
data modify storage bingo:items registry append value {id: "bingo:milk_bucket", item: {id: "minecraft:milk_bucket"}, textComponent: '{"translate": "item.minecraft.milk_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:milk_bucket"}}}', icon: '"\\u0016"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:milk_bucket 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:milk_bucket 1", categories: ["bingo:milk"], weight: 1}
...
## 0018: saddle
data modify storage bingo:items registry append value {id: "bingo:saddle", item: {id: "minecraft:saddle"}, textComponent: '{"translate": "item.minecraft.saddle", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:saddle"}}}', icon: '"\\u0018"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:saddle 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:saddle 1", categories: ["bingo:chest_loot"], weight: 1}

## 0019: name_tag
data modify storage bingo:items registry append value {id: "bingo:name_tag", item: {id: "minecraft:name_tag"}, textComponent: '{"translate": "item.minecraft.name_tag", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:name_tag"}}}', icon: '"\\u0019"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:name_tag 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:name_tag 1", categories: ["bingo:chest_loot"], weight: 1}

## 001a: painting
data modify storage bingo:items registry append value {id: "bingo:painting", item: {id: "minecraft:painting"}, textComponent: '{"translate": "item.minecraft.painting", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:painting"}}}', icon: '"\\u001a"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:painting 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:painting 1", categories: ["bingo:wool"], weight: 1}

## 001b: item_frame
data modify storage bingo:items registry append value {id: "bingo:item_frame", item: {id: "minecraft:item_frame"}, textComponent: '{"translate": "item.minecraft.item_frame", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:item_frame"}}}', icon: '"\\u001b"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:item_frame 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:item_frame 1", categories: ["bingo:leather"], weight: 1}

## 001c: emerald
data modify storage bingo:items registry append value {id: "bingo:emerald", item: {id: "minecraft:emerald"}, textComponent: '{"translate": "item.minecraft.emerald", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:emerald"}}}', icon: '"\\u001c"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:emerald 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:emerald 1", categories: ["bingo:emerald"], weight: 1}
...
## 0021: flower_pot
data modify storage bingo:items registry append value {id: "bingo:flower_pot", item: {id: "minecraft:flower_pot"}, textComponent: '{"translate": "block.minecraft.flower_pot", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:flower_pot"}}}', icon: '"\\u0021"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:flower_pot 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:flower_pot 1", categories: ["bingo:brick"], weight: 1}

## 0022: brick
data modify storage bingo:items registry append value {id: "bingo:brick", item: {id: "minecraft:brick"}, textComponent: '{"translate": "item.minecraft.brick", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:brick"}}}', icon: '"\\u0022"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:brick 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:brick 1", categories: ["bingo:brick"], weight: 1}

## 0023: mushroom_stew
data modify storage bingo:items registry append value {id: "bingo:mushroom_stew", item: {id: "minecraft:mushroom_stew"}, textComponent: '{"translate": "item.minecraft.mushroom_stew", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:mushroom_stew"}}}', icon: '"\\u0023"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:mushroom_stew 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:mushroom_stew 1", categories: ["bingo:mushroom"], weight: 1}

## 0024: beetroot_soup
data modify storage bingo:items registry append value {id: "bingo:beetroot_soup", item: {id: "minecraft:beetroot_soup"}, textComponent: '{"translate": "item.minecraft.beetroot_soup", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:beetroot_soup"}}}', icon: '"\\u0024"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:beetroot_soup 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:beetroot_soup 1", categories: ["bingo:chest_loot"], weight: 1}

## 0025: apple
data modify storage bingo:items registry append value {id: "bingo:apple", item: {id: "minecraft:apple"}, textComponent: '{"translate": "item.minecraft.apple", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:apple"}}}', icon: '"\\u0025"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:apple 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:apple 1", categories: ["bingo:apple"], weight: 1}
...
## 0027: golden_shovel
data modify storage bingo:items registry append value {id: "bingo:golden_shovel", item: {id: "minecraft:golden_shovel"}, textComponent: '{"translate": "item.minecraft.golden_shovel", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_shovel"}}}', icon: '"\\u0027"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:golden_shovel 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_shovel 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0028: golden_sword
data modify storage bingo:items registry append value {id: "bingo:golden_sword", item: {id: "minecraft:golden_sword"}, textComponent: '{"translate": "item.minecraft.golden_sword", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_sword"}}}', icon: '"\\u0028"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:golden_sword 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_sword 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0029: clock
data modify storage bingo:items registry append value {id: "bingo:clock", item: {id: "minecraft:clock"}, textComponent: '{"translate": "item.minecraft.clock", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:clock"}}}', icon: '"\\u0029"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:clock 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:clock 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 002a: repeater
data modify storage bingo:items registry append value {id: "bingo:repeater", item: {id: "minecraft:repeater"}, textComponent: '{"translate": "block.minecraft.repeater", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:repeater"}}}', icon: '"\\u002a"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:repeater 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:repeater 1", categories: ["bingo:redstone"], weight: 1}

## 002b: compass
data modify storage bingo:items registry append value {id: "bingo:compass", item: {id: "minecraft:compass"}, textComponent: '{"translate": "item.minecraft.compass", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:compass"}}}', icon: '"\\u002b"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:compass 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:compass 1", categories: ["bingo:compass"], weight: 1}

## 002c: map
data modify storage bingo:items registry append value {id: "bingo:map", item: {id: "minecraft:map"}, textComponent: '{"translate": "item.minecraft.map", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:map"}}}', icon: '"\\u002c"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:map 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:map 1", categories: ["bingo:compass"], weight: 1}

## 002d: book
data modify storage bingo:items registry append value {id: "bingo:book", item: {id: "minecraft:book"}, textComponent: '{"translate": "item.minecraft.book", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:book"}}}', icon: '"\\u002d"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:book 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:book 1", categories: ["bingo:leather"], weight: 1}

## 002e: writable_book
data modify storage bingo:items registry append value {id: "bingo:writable_book", item: {id: "minecraft:writable_book"}, textComponent: '{"translate": "item.minecraft.writable_book", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:writable_book"}}}', icon: '"\\u002e"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:writable_book 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:writable_book 1", categories: ["bingo:leather", "bingo:ink"], weight: 1}
...
## 0030: spider_eye
data modify storage bingo:items registry append value {id: "bingo:spider_eye", item: {id: "minecraft:spider_eye"}, textComponent: '{"translate": "item.minecraft.spider_eye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:spider_eye"}}}', icon: '"\\u0030"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:spider_eye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:spider_eye 1", categories: ["bingo:spider"], weight: 1}

## 0031: fermented_spider_eye
data modify storage bingo:items registry append value {id: "bingo:fermented_spider_eye", item: {id: "minecraft:fermented_spider_eye"}, textComponent: '{"translate": "item.minecraft.fermented_spider_eye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:fermented_spider_eye"}}}', icon: '"\\u0031"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:fermented_spider_eye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:fermented_spider_eye 1", categories: ["bingo:spider", "bingo:mushroom"], weight: 1}

## 0032: gunpowder
data modify storage bingo:items registry append value {id: "bingo:gunpowder", item: {id: "minecraft:gunpowder"}, textComponent: '{"translate": "item.minecraft.gunpowder", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:gunpowder"}}}', icon: '"\\u0032"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:gunpowder 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:gunpowder 1", categories: ["bingo:gunpowder"], weight: 1}

## 0033: tnt_minecart
data modify storage bingo:items registry append value {id: "bingo:tnt_minecart", item: {id: "minecraft:tnt_minecart"}, textComponent: '{"translate": "item.minecraft.tnt_minecart", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:tnt_minecart"}}}', icon: '"\\u0033"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:tnt_minecart 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:tnt_minecart 1", categories: ["bingo:gunpowder", "bingo:sand"], weight: 1}

## 0034: hopper
data modify storage bingo:items registry append value {id: "bingo:hopper", item: {id: "minecraft:hopper"}, textComponent: '{"translate": "block.minecraft.hopper", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hopper"}}}', icon: '"\\u0034"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:hopper 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:hopper 1", categories: ["bingo:chest_iron"], weight: 1}

## 0035: hopper_minecart
data modify storage bingo:items registry append value {id: "bingo:hopper_minecart", item: {id: "minecraft:hopper_minecart"}, textComponent: '{"translate": "item.minecraft.hopper_minecart", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hopper_minecart"}}}', icon: '"\\u0035"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:hopper_minecart 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:hopper_minecart 1", categories: ["bingo:chest_iron"], weight: 1}
...
## 0038: bone
data modify storage bingo:items registry append value {id: "bingo:bone", item: {id: "minecraft:bone"}, textComponent: '{"translate": "item.minecraft.bone", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bone"}}}', icon: '"\\u0038"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:bone 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:bone 1", categories: ["bingo:ink_bone", "bingo:cactus_bone"], weight: 1}

## 0039: ink_sac
data modify storage bingo:items registry append value {id: "bingo:ink_sac", item: {id: "minecraft:ink_sac"}, textComponent: '{"translate": "item.minecraft.ink_sac", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:ink_sac"}}}', icon: '"\\u0039"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:ink_sac 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:ink_sac 1", categories: ["bingo:ink"], weight: 1}

## 003a: gray_dye
data modify storage bingo:items registry append value {id: "bingo:gray_dye", item: {id: "minecraft:gray_dye"}, textComponent: '{"translate": "item.minecraft.gray_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:gray_dye"}}}', icon: '"\\u003a"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:gray_dye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:gray_dye 1", categories: ["bingo:ink", "bingo:ink_bone"], weight: 1}

## 003b: green_dye
data modify storage bingo:items registry append value {id: "bingo:green_dye", item: {id: "minecraft:green_dye"}, textComponent: '{"translate": "item.minecraft.green_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:green_dye"}}}', icon: '"\\u003b"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:green_dye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:green_dye 1", categories: ["bingo:cactus"], weight: 1}

## 003c: lime_dye
data modify storage bingo:items registry append value {id: "bingo:lime_dye", item: {id: "minecraft:lime_dye"}, textComponent: '{"translate": "item.minecraft.lime_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lime_dye"}}}', icon: '"\\u003c"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:lime_dye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:lime_dye 1", categories: ["bingo:cactus", "bingo:cactus_bone", "bingo:lime"], weight: 1}

## 003d: lapis_lazuli
data modify storage bingo:items registry append value {id: "bingo:lapis_lazuli", item: {id: "minecraft:lapis_lazuli"}, textComponent: '{"translate": "item.minecraft.lapis_lazuli", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lapis_lazuli"}}}', icon: '"\\u003d"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:lapis_lazuli 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:lapis_lazuli 1", categories: ["bingo:lapis"], weight: 1}

## 003e: cyan_dye
data modify storage bingo:items registry append value {id: "bingo:cyan_dye", item: {id: "minecraft:cyan_dye"}, textComponent: '{"translate": "item.minecraft.cyan_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cyan_dye"}}}', icon: '"\\u003e"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:cyan_dye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:cyan_dye 1", categories: ["bingo:lapis", "bingo:cactus"], weight: 1}

## 003f: purple_dye
data modify storage bingo:items registry append value {id: "bingo:purple_dye", item: {id: "minecraft:purple_dye"}, textComponent: '{"translate": "item.minecraft.purple_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:purple_dye"}}}', icon: '"\\u003f"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:purple_dye 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:purple_dye 1", categories: ["bingo:lapis"], weight: 1}

## 0040: suspicious_stew
data modify storage bingo:items registry append value {id: "bingo:suspicious_stew", item: {id: "minecraft:suspicious_stew"}, textComponent: '{"translate": "item.minecraft.suspicious_stew", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:suspicious_stew"}}}', icon: '"\\u0040"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:suspicious_stew 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:suspicious_stew 1", categories: ["bingo:mushroom"], weight: 1}
...
## 0042: cod
data modify storage bingo:items registry append value {id: "bingo:cod", item: {id: "minecraft:cod"}, textComponent: '{"translate": "item.minecraft.cod", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cod"}}}', icon: '"\\u0042"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:cod 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:cod 1", categories: ["bingo:fish"], weight: 1}

## 0043: cod_bucket
data modify storage bingo:items registry append value {id: "bingo:cod_bucket", item: {id: "minecraft:cod_bucket"}, textComponent: '{"translate": "item.minecraft.cod_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:cod_bucket"}}}', icon: '"\\u0043"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:cod_bucket 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:cod_bucket 1", categories: ["bingo:fish"], weight: 1}

## 0044: salmon
data modify storage bingo:items registry append value {id: "bingo:salmon", item: {id: "minecraft:salmon"}, textComponent: '{"translate": "item.minecraft.salmon", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:salmon"}}}', icon: '"\\u0044"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:salmon 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:salmon 1", categories: ["bingo:fish"], weight: 1}

## 0045: salmon_bucket
data modify storage bingo:items registry append value {id: "bingo:salmon_bucket", item: {id: "minecraft:salmon_bucket"}, textComponent: '{"translate": "item.minecraft.salmon_bucket", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:salmon_bucket"}}}', icon: '"\\u0045"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:salmon_bucket 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:salmon_bucket 1", categories: ["bingo:fish"], weight: 1}
...
## 0048: birch_sapling
data modify storage bingo:items registry append value {id: "bingo:birch_sapling", item: {id: "minecraft:birch_sapling"}, textComponent: '{"translate": "block.minecraft.birch_sapling", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:birch_sapling"}}}', icon: '"\\u0048"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:birch_sapling 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:birch_sapling 1", categories: ["bingo:sapling"], weight: 1}

## 0049: dark_oak_sapling
data modify storage bingo:items registry append value {id: "bingo:dark_oak_sapling", item: {id: "minecraft:dark_oak_sapling"}, textComponent: '{"translate": "block.minecraft.dark_oak_sapling", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dark_oak_sapling"}}}', icon: '"\\u0049"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:dark_oak_sapling 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:dark_oak_sapling 1", categories: ["bingo:sapling"], weight: 1}
...
## 004e: bell
#data modify storage bingo:items registry append value {id: "bingo:bell", item: {id: "minecraft:bell"}, textComponent: '{"translate": "block.minecraft.bell", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bell"}}}', icon: '"\\u004e"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:bell 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:bell 1", categories: ["bingo:village"], weight: 1}
...
## 0050: diamond_sword
data modify storage bingo:items registry append value {id: "bingo:diamond_sword", item: {id: "minecraft:diamond_sword"}, textComponent: '{"translate": "item.minecraft.diamond_sword", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:diamond_sword"}}}', icon: '"\\u0050"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:diamond_sword 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:diamond_sword 1", categories: ["bingo:diamond"], weight: 1}
...
## 0052: golden_axe
data modify storage bingo:items registry append value {id: "bingo:golden_axe", item: {id: "minecraft:golden_axe"}, textComponent: '{"translate": "item.minecraft.golden_axe", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_axe"}}}', icon: '"\\u0052"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:golden_axe 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_axe 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0053: golden_pickaxe
data modify storage bingo:items registry append value {id: "bingo:golden_pickaxe", item: {id: "minecraft:golden_pickaxe"}, textComponent: '{"translate": "item.minecraft.golden_pickaxe", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_pickaxe"}}}', icon: '"\\u0053"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:golden_pickaxe 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_pickaxe 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0054: golden_hoe
data modify storage bingo:items registry append value {id: "bingo:golden_hoe", item: {id: "minecraft:golden_hoe"}, textComponent: '{"translate": "item.minecraft.golden_hoe", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:golden_hoe"}}}', icon: '"\\u0054"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:golden_hoe 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:golden_hoe 1", categories: ["bingo:gold_and_ruined_portal"], weight: 1}

## 0055: crossbow
data modify storage bingo:items registry append value {id: "bingo:crossbow", item: {id: "minecraft:crossbow"}, textComponent: '{"translate": "item.minecraft.crossbow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:crossbow"}}}', icon: '"\\u0055"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:crossbow 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:crossbow 1", categories: ["bingo:bow"], weight: 1}

## 0056: bamboo
data modify storage bingo:items registry append value {id: "bingo:bamboo", item: {id: "minecraft:bamboo"}, textComponent: '{"translate": "block.minecraft.bamboo", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bamboo"}}}', icon: '"\\u0056"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:bamboo 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:bamboo 1", categories: ["bingo:jungle"], weight: 1}

## 0057: sea_pickle
data modify storage bingo:items registry append value {id: "bingo:sea_pickle", item: {id: "minecraft:sea_pickle"}, textComponent: '{"translate": "block.minecraft.sea_pickle", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:sea_pickle"}}}', icon: '"\\u0057"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:sea_pickle 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:sea_pickle 1", categories: ["bingo:lime"], weight: 1}
...
## 0059: rabbit_hide
data modify storage bingo:items registry append value {id: "bingo:rabbit_hide", item: {id: "minecraft:rabbit_hide"}, textComponent: '{"translate": "item.minecraft.rabbit_hide", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:rabbit_hide"}}}', icon: '"\\u0059"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:rabbit_hide 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:rabbit_hide 1", categories: ["bingo:rabbit"], weight: 1}
...
## 0102: bookshelf
data modify storage bingo:items registry append value {id: "bingo:bookshelf", item: {id: "minecraft:bookshelf"}, textComponent: '{"translate": "block.minecraft.bookshelf", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bookshelf"}}}', icon: '"\\u0102"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:bookshelf 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:bookshelf 1", categories: ["bingo:leather"], weight: 1}

## 0103: obsidian
data modify storage bingo:items registry append value {id: "bingo:obsidian", item: {id: "minecraft:obsidian"}, textComponent: '{"translate": "block.minecraft.obsidian", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:obsidian"}}}', icon: '"\\u0103"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:obsidian 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:obsidian 1", categories: ["bingo:diamond"], weight: 1}

## 0104: melon
data modify storage bingo:items registry append value {id: "bingo:melon", item: {id: "minecraft:melon"}, textComponent: '{"translate": "block.minecraft.melon", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:melon"}}}', icon: '"\\u0104"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:melon 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:melon 1", categories: ["bingo:jungle"], weight: 1}

## 0105: mossy_stone_bricks
data modify storage bingo:items registry append value {id: "bingo:mossy_stone_bricks", item: {id: "minecraft:mossy_stone_bricks"}, textComponent: '{"translate": "block.minecraft.mossy_stone_bricks", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:mossy_stone_bricks"}}}', icon: '"\\u0105"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:mossy_stone_bricks 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:mossy_stone_bricks 1", categories: ["bingo:shearable"], weight: 1}

## 0106: jukebox
data modify storage bingo:items registry append value {id: "bingo:jukebox", item: {id: "minecraft:jukebox"}, textComponent: '{"translate": "block.minecraft.jukebox", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:jukebox"}}}', icon: '"\\u0106"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:jukebox 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:jukebox 1", categories: ["bingo:diamond"], weight: 1}
...
## 0108: bone_block
data modify storage bingo:items registry append value {id: "bingo:bone_block", item: {id: "minecraft:bone_block"}, textComponent: '{"translate": "block.minecraft.bone_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:bone_block"}}}', icon: '"\\u0108"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:bone_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:bone_block 1", categories: ["bingo:ink_bone", "bingo:cactus_bone"], weight: 1}

## 0109: blast_furnace
data modify storage bingo:items registry append value {id: "bingo:blast_furnace", item: {id: "minecraft:blast_furnace"}, textComponent: '{"translate": "block.minecraft.blast_furnace", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:blast_furnace"}}}', icon: '"\\u0109"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:blast_furnace 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:blast_furnace 1", categories: ["bingo:furnace"], weight: 1}
...
## 010b: red_bed
data modify storage bingo:items registry append value {id: "bingo:red_bed", item: {id: "minecraft:red_bed"}, textComponent: '{"translate": "block.minecraft.red_bed", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:red_bed"}}}', icon: '"\\u010b"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:red_bed 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:red_bed 1", categories: ["bingo:wool"], weight: 1}

## 010c: target
data modify storage bingo:items registry append value {id: "bingo:target", item: {id: "minecraft:target"}, textComponent: '{"translate": "block.minecraft.target", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:target"}}}', icon: '"\\u010c"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:target 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:target 1", categories: ["bingo:wheat"], weight: 1}

## 010d: snow
data modify storage bingo:items registry append value {id: "bingo:snow", item: {id: "minecraft:snow"}, textComponent: '{"translate": "block.minecraft.snow", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:snow"}}}', icon: '"\\u010d"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:snow 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:snow 1", categories: ["bingo:snow"], weight: 1}

## 010e: snow_block
data modify storage bingo:items registry append value {id: "bingo:snow_block", item: {id: "minecraft:snow_block"}, textComponent: '{"translate": "block.minecraft.snow_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:snow_block"}}}', icon: '"\\u010e"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:snow_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:snow_block 1", categories: ["bingo:snow"], weight: 1}
...
## 0110: tnt
data modify storage bingo:items registry append value {id: "bingo:tnt", item: {id: "minecraft:tnt"}, textComponent: '{"translate": "block.minecraft.tnt", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:tnt"}}}', icon: '"\\u0110"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:tnt 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:tnt 1", categories: ["bingo:gunpowder", "bingo:sand"], weight: 1}

## 0111: lapis_block
data modify storage bingo:items registry append value {id: "bingo:lapis_block", item: {id: "minecraft:lapis_block"}, textComponent: '{"translate": "block.minecraft.lapis_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lapis_block"}}}', icon: '"\\u0111"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:lapis_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:lapis_block 1", categories: ["bingo:lapis"], weight: 1}

## 0112: dispenser
data modify storage bingo:items registry append value {id: "bingo:dispenser", item: {id: "minecraft:dispenser"}, textComponent: '{"translate": "block.minecraft.dispenser", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dispenser"}}}', icon: '"\\u0112"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:dispenser 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:dispenser 1", categories: ["bingo:bow"], weight: 1}

## 113: smoker
data modify storage bingo:items registry append value {id: "bingo:smoker", item: {id: "minecraft:smoker"}, textComponent: '{"translate": "block.minecraft.smoker", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:smoker"}}}', icon: '"\\u0113"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:smoker 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:smoker 1", categories: ["bingo:furnace"], weight: 1}

## 114: dried_kelp_block
data modify storage bingo:items registry append value {id: "bingo:dried_kelp_block", item: {id: "minecraft:dried_kelp_block"}, textComponent: '{"translate": "block.minecraft.dried_kelp_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:dried_kelp_block"}}}', icon: '"\\u0114"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:dried_kelp_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:dried_kelp_block 1", categories: ["bingo:nine_smelts_one"], weight: 1}

## 115: hay_bale
data modify storage bingo:items registry append value {id: "bingo:hay_bale", item: {id: "minecraft:hay_block"}, textComponent: '{"translate": "block.minecraft.hay_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hay_block"}}}', icon: '"\\u0115"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:hay_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:hay_block 1", categories: ["bingo:wheat"], weight: 1}
...
## 117: lectern
data modify storage bingo:items registry append value {id: "bingo:lectern", item: {id: "minecraft:lectern"}, textComponent: '{"translate": "block.minecraft.lectern", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:lectern"}}}', icon: '"\\u0117"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:lectern 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:lectern 1", categories: ["bingo:leather"], weight: 1}

## 118: crying_obsidian
data modify storage bingo:items registry append value {id: "bingo:crying_obsidian", item: {id: "minecraft:crying_obsidian"}, textComponent: '{"translate": "block.minecraft.crying_obsidian", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:crying_obsidian"}}}', icon: '"\\u0118"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:crying_obsidian 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:crying_obsidian 1", categories: ["bingo:diamond", "bingo:gold_and_ruined_portal"], weight: 1}

## 119: gold_block
data modify storage bingo:items registry append value {id: "bingo:gold_block", item: {id: "minecraft:gold_block"}, textComponent: '{"translate": "block.minecraft.gold_block", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:gold_block"}}}', icon: '"\\u0119"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:gold_block 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:gold_block 1", categories: ["bingo:gold_and_ruined_portal", "bingo:nine_smelts_one"], weight: 1}
...
## 11b: piston
data modify storage bingo:items registry append value {id: "bingo:piston", item: {id: "minecraft:piston"}, textComponent: '{"translate": "block.minecraft.piston", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:piston"}}}', icon: '"\\u011b"', detectCommand: "execute as @a store success score @s bingo.has_item run clear @s minecraft:piston 0", clearCommand: "clear @a[tag=bingo.clear] minecraft:piston 1", categories: ["bingo:redstone"], weight: 1}
