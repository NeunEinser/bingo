...
execute unless data storage temp:bingo.init/hud whereSpace[0] run data modify storage bingo:custom_hud default append value {id: "bingo:blank", padding: '{"translate": "space.91"}'}
