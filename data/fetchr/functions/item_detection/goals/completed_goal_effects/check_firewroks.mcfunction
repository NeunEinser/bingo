...
execute if score $goal_effects/fireworks.life fetchr.tmp = $goal_effects/fireworks.life_time fetchr.tmp run data modify entity @s FireworksItem.tag.Fireworks.Explosions set from entity @s FireworksItem.tag.__custom__.bingo.explosions
execute if score $goal_effects/fireworks.y fetchr.tmp = @s fetchr.prev_y_pos run data modify entity @s FireworksItem.tag.Fireworks.Explosions set from entity @s FireworksItem.tag.__custom__.bingo.explosions
