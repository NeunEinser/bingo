...
execute if score @s fetchr.pref matches 64 run data modify storage tmp.fetchr:preferences/hud toBeAdded set from storage fetchr:custom_hud currentPlayer.components[5]
execute if score @s fetchr.pref matches 64 run function fetchr:preferences/custom_hud/add_to_col0
data modify storage fetchr:custom_hud currentPlayer.components[5] set from storage fetchr:custom_hud currentPlayer.components[6]
data modify storage fetchr:custom_hud currentPlayer.components[6] set from storage fetchr:custom_hud currentPlayer.components[7]
