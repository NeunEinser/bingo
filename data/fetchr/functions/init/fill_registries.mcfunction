...
## 003b: green_dye
data modify storage fetchr:registries items append value {id: "fetchr:green_dye", item: {id: "minecraft:green_dye"}, textComponent: '{"translate": "item.minecraft.green_dye", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:green_dye"}}}', icon: '"\\u003b"', detectCommand: "execute as @a[tag=fetchr.check_slot] store success score @s fetchr.has_item run clear @s minecraft:green_dye 0", clearCommand: "clear @a[tag=fetchr.clear] minecraft:green_dye 1", categories: ["fetchr:cactus"]}
...
data modify storage fetchr:registries items append value {id: "fetchr:fletching_table", item: {id: "minecraft:fletching_table"}, textComponent: '{"translate": "block.minecraft.fletching_table", "hoverEvent": {"action": "show_item", "contents": {"id": "minecraft:hay_bale"}}}', icon: '"\\u0116"', detectCommand: "execute as @a[tag=fetchr.check_slot] store success score @s fetchr.has_item run clear @s minecraft:fletching_table 0", clearCommand: "clear @a[tag=fetchr.clear] minecraft:fletching_table 1", categories: ["fetchr:flint"]}
