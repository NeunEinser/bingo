...
execute store success score $init/items/normalize.is_string fetchr.tmp run data modify entity @s Tags append from storage tmp.fetchr:init itemCategories[-1]
