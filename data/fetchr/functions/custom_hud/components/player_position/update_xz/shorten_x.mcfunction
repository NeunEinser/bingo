...
execute if score $custom_hud/width.characters fetchr.tmp matches 12.. if score $custom_hud/player_pos.abs_x fetchr.tmp >= $custom_hud/player_pos.abs_z fetchr.tmp run function fetchr:custom_hud/components/player_position/update_xz/shorten_x_iter
