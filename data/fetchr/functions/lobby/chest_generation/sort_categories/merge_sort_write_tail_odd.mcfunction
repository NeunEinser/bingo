#> fetchr:lobby/chest_generation/sort_categories/merge_sort_write_tail_odd
#
...
execute if data storage tmp.fetchr:chest_generation mergeSort.even[-1][0] run function fetchr:lobby/chest_generation/sort_categories/merge_sort_write_tail_odd