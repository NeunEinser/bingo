...
data modify block 7 0 7 Text1 set value '[{"storage": "tmp.fetchr:game/start", "nbt": "backgroundTemplate[0]", "interpret": true, "color": "gray"}, {"translate": "space.-21", "font": "space:default"}]'
