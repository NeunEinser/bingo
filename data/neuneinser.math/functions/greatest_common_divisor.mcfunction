#> neuneinser.math:greatest_common_divisor
#
...
#>
# Input for neuneinser.math:greatest_common_divisor
#
#@api
...
#>
# Output for neuneinser.math:greatest_common_divisor
#
#@api
#declare score_holder $gcd.result

execute if score $gcd.b 91.math.io > $gcd.a 91.math.io run function neuneinser.math:greatest_common_divisor/swap
...
execute if score $gcd.b 91.math.io matches 1.. run function neuneinser.math:greatest_common_divisor