...
scoreboard players operation $seconds 91.timer.time /= $blocks_per_second 91.timer.time
...
scoreboard players operation $millis 91.timer.time %= $blocks_per_second 91.timer.time
