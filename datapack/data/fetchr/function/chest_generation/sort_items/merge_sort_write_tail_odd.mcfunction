#> fetchr:chest_generation/sort_items/merge_sort_write_tail_odd
#
...
execute if data storage tmp.fetchr:chest_generation mergeSort.even[-1][0] run function fetchr:chest_generation/sort_items/merge_sort_write_tail_odd