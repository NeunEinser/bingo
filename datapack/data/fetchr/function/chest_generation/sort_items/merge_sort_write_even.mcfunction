#> fetchr:chest_generation/sort_items/merge_sort_write_even
#
# This function sorts the next 2 lists into the current output list
#
# @writes storage tmp.fetchr:chest_generation categories
# @within
# 	function fetchr:chest_generation/sort_items/merge_sort_even
# 	function fetchr:chest_generation/sort_items/merge_sort_write_even
...
execute store result score $chest_generation/sort.a fetchr.tmp run data get storage tmp.fetchr:chest_generation mergeSort.odd[-1][-1].global_weight
execute store result score $chest_generation/sort.b fetchr.tmp run data get storage tmp.fetchr:chest_generation mergeSort.odd[-2][-1].global_weight
...
execute if data storage tmp.fetchr:chest_generation mergeSort.odd[-1][0] if data storage tmp.fetchr:chest_generation mergeSort.odd[-2][0] run function fetchr:chest_generation/sort_items/merge_sort_write_even