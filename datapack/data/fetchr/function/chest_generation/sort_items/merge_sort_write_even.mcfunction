#> fetchr:lobby/chest_generation/sort_items/merge_sort_write_even
#
...
execute if data storage tmp.fetchr:chest_generation mergeSort.odd[-1][0] if data storage tmp.fetchr:chest_generation mergeSort.odd[-2][0] run function fetchr:lobby/chest_generation/sort_items/merge_sort_write_even