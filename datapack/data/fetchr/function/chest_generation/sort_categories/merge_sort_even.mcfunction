#> fetchr:lobby/chest_generation/sort_categories/merge_sort_even
#
...
execute unless data storage tmp.fetchr:chest_generation mergeSort.odd[0] run function fetchr:lobby/chest_generation/sort_categories/merge_sort_odd
execute if data storage tmp.fetchr:chest_generation mergeSort.odd[0] if data storage tmp.fetchr:chest_generation mergeSort.even[0] run function fetchr:lobby/chest_generation/sort_categories/merge_sort_even