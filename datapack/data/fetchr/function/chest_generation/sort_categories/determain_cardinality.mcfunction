#> fetchr:chest_generation/sort_categories/determain_cardinality
#
...
#>
# Input for fetchr:chest_generation/sort_categories/determain_cardinality
# @within
# 	function fetchr:chest_generation/sort_categories/determain_cardinality
# 	function fetchr:chest_generation/generate_item_chests
#declare score_holder $chest_generation/sort/card.size
#>
# Output for fetchr:chest_generation/sort_categories/determain_cardinality
# @within
# 	function fetchr:chest_generation/sort_categories/determain_cardinality
# 	function fetchr:chest_generation/generate_item_chests
...
execute if score $chest_generation/sort/card.size fetchr.tmp matches 1.. run function fetchr:chest_generation/sort_categories/determain_cardinality