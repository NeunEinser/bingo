#> fetchr:chest_generation/sort_categories/merge_sort_write_odd
#
...
execute if data storage tmp.fetchr:chest_generation mergeSort.even[-1][0] if data storage tmp.fetchr:chest_generation mergeSort.even[-2][0] run function fetchr:chest_generation/sort_categories/merge_sort_write_odd