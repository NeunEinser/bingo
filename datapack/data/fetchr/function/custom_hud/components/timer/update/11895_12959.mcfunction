...
#execute \
	if score $custom_hud/timer.daytime fetchr.tmp matches ..12254 \
	run data modify storage io.fetchr:custom_hud component.icon set value '"\\u010E"'
#execute \
	if score $custom_hud/timer.daytime fetchr.tmp matches 12255..12609 \
	run data modify storage io.fetchr:custom_hud component.icon set value '"\U010F"'
#execute \
	if score $custom_hud/timer.daytime fetchr.tmp matches 12610.. \
