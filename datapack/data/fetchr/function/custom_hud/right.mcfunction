...
#right edge (gui 2)
execute if score @s fetchr.card_position matches 11 run data merge storage fetchr:tmp {cardOffset:'"\\u0178"',cardNegOffset:'"\\ufe88"'}
#right edge (gui 3)
execute if score @s fetchr.card_position matches 12 run data merge storage fetchr:tmp {cardOffset:'"\\u00d8"',cardNegOffset:'"\\uff28"'}
#right edge (gui 4)
execute if score @s fetchr.card_position matches 13 run data merge storage fetchr:tmp {cardOffset:'"\\u0088"',cardNegOffset:'"\\uff78"'}