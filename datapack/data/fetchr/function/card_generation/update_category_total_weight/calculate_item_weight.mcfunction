...
execute store result score $card_gen/cat_weight.total_weight fetchr.tmp run data get storage tmp.fetchr:card_generation item_categories[-1].total_item_weight
...
execute store result storage tmp.fetchr:card_generation item_categories[-1].total_item_weight int 1 run scoreboard players get $card_gen/cat_weight.total_weight fetchr.tmp

#>
# @private
#declare score_holder $card_gen/cat_weight.item_weight
execute store result score $card_gen/cat_weight.item_weight fetchr.tmp run data get storage tmp.fetchr:card_generation item_categories[-1].weight
