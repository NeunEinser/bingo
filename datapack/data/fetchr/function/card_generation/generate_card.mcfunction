...
execute as @e[type=minecraft:item_frame, tag=fetchr.card_frame] run data modify entity @s Item set value { id: "minecraft:barrier" }
...
execute if score $blind_mode fetchr.state matches 1 as @e[type=minecraft:item_frame, tag=fetchr.card_frame] run data modify entity @s Item set value { id: "minecraft:barrier" }
