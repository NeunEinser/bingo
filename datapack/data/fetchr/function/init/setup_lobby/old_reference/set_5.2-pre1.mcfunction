...
execute \
	if entity @e[type=minecraft:area_effect_cloud, tag=bingo.sign_machinery, limit=1] \
	run function fetchr:init/setup_lobby/old_reference/set_5.1.3

execute \
	unless entity @e[type=minecraft:area_effect_cloud, tag=bingo.sign_machinery, limit=1] \
...
execute \
	unless entity @e[type=minecraft:area_effect_cloud, tag=bingo.sign_machinery] \
