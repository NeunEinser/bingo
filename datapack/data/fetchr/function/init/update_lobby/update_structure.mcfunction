...
scoreboard players operation $init/lobby/update/compare_and_update.offset_x fetchr.tmp = $init/lobby/update.new_size_x fetchr.tmp
scoreboard players operation $init/lobby/update/compare_and_update.offset_z fetchr.tmp = $init/lobby/update.size_y fetchr.tmp
scoreboard players operation $init/lobby/update/compare_and_update.offset_y fetchr.tmp = $init/lobby/update.size_z fetchr.tmp
...
execute \
	...
	run scoreboard players remove $init/lobby/update/compare_and_update.offset_x fetchr.tmp 1
execute \
	store result storage tmp.fetchr:init/update_lobby compare_coordinates[0].offset_y int 1 \
	run scoreboard players remove $init/lobby/update/compare_and_update.offset_y fetchr.tmp 1
execute \
	store result storage tmp.fetchr:init/update_lobby compare_coordinates[0].offset_z int 1 \
	run scoreboard players remove $init/lobby/update/compare_and_update.offset_z fetchr.tmp 1
execute \
