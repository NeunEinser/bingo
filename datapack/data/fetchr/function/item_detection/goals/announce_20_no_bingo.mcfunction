...
title @a[tag=fetchr.in_current_team] subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.your_team" }
execute \
	if score $item_detect/goal.winner_count fetchr.tmp matches 1 \
	run title @a[tag=fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.you" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:black" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.black" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:blue" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.blue" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:cyan" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.cyan" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:dark_blue" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.dark_blue" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:dark_gray" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.dark_gray" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:dark_red" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.dark_red" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:gray" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.gray" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:green" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.green" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:light_blue" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.light_blue" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:lime" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.lime" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:magenta" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.magenta" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:orange" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.orange" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:purple" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.purple" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:red" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.red" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:white" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.white" }
execute \
	if data storage tmp.fetchr:item_detection team{ id: "fetchr:yellow" } \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.yellow" }
execute \
	if score $item_detect/goal.winner_count fetchr.tmp matches 1 \
	run title @a[tag=!fetchr.in_current_team] \
		subtitle { "translate": "fetchr.goal.20_no_bingo.subtitle.player", "with": [{"selector": "@s"}] }
