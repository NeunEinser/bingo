...
#>
# @within function fetchr:item_detection/goals/**/*
#declare tag fetchr.in_winning_team

scoreboard players add $item_detect/goal.winning_teams fetchr.tmp 1
