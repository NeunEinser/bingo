...
title @a[tag=fetchr.in_team] \
	subtitle [{ "translate": "fetchr.goal.lockout.subtitle.won" }]
title @a[predicate=fetchr:is_in_game, tag=!fetchr.in_team] \
	subtitle [{ "translate": "fetchr.goal.lockout.subtitle.lost" }]
title @a[tag=fetchr.in_team] \
	title [{ "translate": "fetchr.goal.lockout.title.won", "color": "green" }]
title @a[predicate=fetchr:is_in_game, tag=!fetchr.in_team] \
