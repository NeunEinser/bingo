...
data modify storage tmp.fetchr:game/goal_detection data merge value { barrel_slot: 3, card_slot: 0 }
execute \
	unless data storage tmp.fetchr:game/goal_detection data{revealed: true} \
