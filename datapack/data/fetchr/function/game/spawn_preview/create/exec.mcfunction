#> fetchr:game/spawn_preview/create/exec
#
# Create a spawn_preview for the game.
#
# @within
...
execute \
	...
	at @s \
	run function fetchr:game/spawn_preview/create/remove_old_preview
execute \
	positioned over motion_blocking \
	summon minecraft:marker \
	run function fetchr:game/spawn_preview/create/internal
