#> fetchr:game/spawn_preview/create/place_dirt
#
...
execute if score $game/start/place_dirt.y fetchr.tmp matches ..62 run fill ~-7 62 ~-7 ~8 62 ~8 minecraft:dirt replace #minecraft:air
