#> fetchr:game/spawn_preview/setup_team_display/set_team_name
#
# Sets the team name to the name of @s
#
# @within function fetchr:game/spawn_preview/setup_team_display/*
...
#data remove storage tmp.fetchr:spawn_preview team_name.translate
#data \
	modify storage tmp.fetchr:spawn_preview team_name.text \
