#> fetchr:game/start/init_teams/orange
#
# Initializes the orange team
#
...
#data \
	...
	{ "storage": "tmp.fetchr:game/start", "nbt": "backgroundTemplate[0]", "interpret": true, "color": "gold" },\
...
#NEUN_SCRIPT end
data \
	modify storage fetchr:card teams[{ id: "fetchr:orange" }].background \
