#> fetchr:game/start/init_teams/cyan
#
# Initializes the cyan team
#
# @within function fetchr:game/start/init_teams

data modify block 7 0 7 front_text.messages[0] set value '[{"storage": "tmp.fetchr:game/start", "nbt": "backgroundTemplate[0]", "interpret": true, "color": "dark_aqua"}, {"text": "\\uffeb", "font": "fetchr:space"}]'
data modify storage fetchr:card teams[{id: "fetchr:cyan"}].background set from block 7 0 7 front_text.messages[0]
