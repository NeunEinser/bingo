#> fetchr:lobby/chest_generation/sort_categories/merge_sort_odd
#
...
function fetchr:lobby/chest_generation/sort_categories/merge_sort_write_tail_odd

data remove storage tmp.fetchr:chest_generation mergeSort.even[-1]
execute unless data storage tmp.fetchr:chest_generation mergeSort.even[-1][0] run data remove storage tmp.fetchr:chest_generation mergeSort.even[-1]

execute unless data storage tmp.fetchr:chest_generation mergeSort.even[0] if data storage tmp.fetchr:chest_generation mergeSort.odd[1] run function fetchr:lobby/chest_generation/sort_categories/merge_sort_even
execute if data storage tmp.fetchr:chest_generation mergeSort.even[0] if data storage tmp.fetchr:chest_generation mergeSort.odd[0] run function fetchr:lobby/chest_generation/sort_categories/merge_sort_odd