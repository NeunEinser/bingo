#> fetchr:lobby/chest_generation/sort_items/determain_cardinality
#
...
#>
# Input for fetchr:lobby/chest_generation/sort_items/determain_cardinality
# @within
# 	function fetchr:lobby/chest_generation/sort_items/determain_cardinality
# 	function fetchr:lobby/chest_generation/category_iter
#declare score_holder $chest_generation/sort/card.size
#>
# Output for fetchr:lobby/chest_generation/sort_items/determain_cardinality
# @within
# 	function fetchr:lobby/chest_generation/sort_items/determain_cardinality
# 	function fetchr:lobby/chest_generation/category_iter
...
execute if score $chest_generation/sort/card.size fetchr.tmp matches 1.. run function fetchr:lobby/chest_generation/sort_items/determain_cardinality