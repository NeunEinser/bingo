...
execute if score $is_multiplayer fetchr.state matches 1 if score $lobby_gamemode fetchr.setting_values matches 0 run gamemode adventure @s[gamemode=survival]
execute if score $is_multiplayer fetchr.state matches 1 if score $lobby_gamemode fetchr.setting_values matches 1 run gamemode survival @s[gamemode=adventure]
...
execute if score @s fetchr.target_time_minutes matches -2147483648.. unless score @s fetchr.target_time_minutes matches 0 run function fetchr:lobby/settings/set_target_time_internal
