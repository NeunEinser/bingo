#> fetchr:util/string/until_quote
#
# Modifies the given string to be truncated after the first unescaped quote.
#
# @public
...
scoreboard players set $util/string.escaped fetchr.tmp -1
scoreboard players set $util/string.until fetchr.tmp 0
...
function fetchr:util/string/until_quote_iter with storage tmp.fetchr:util until_quote
