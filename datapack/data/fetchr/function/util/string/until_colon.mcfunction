#> fetchr:util/string/until_colon
#
# Modifies the given string to be truncated after the first unescaped colon.
#
# @public
...
function fetchr:util/string/until_colon_iter with storage tmp.fetchr:util until_quote
