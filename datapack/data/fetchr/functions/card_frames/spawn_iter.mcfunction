...
execute unless score $blind_mode fetchr.settings matches 1 run data modify entity @e[type=minecraft:item_frame, tag=fetchr.new, limit=1] Item set from storage tmp.fetchr:card_frames/spawn_frames slots[0].item.item
