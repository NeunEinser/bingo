...
#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.initial_release.name}" = "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}"
	#tellraw @a {\
...
#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.initial_release.name}" != "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}"
	#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.initial_release.name}" = "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_release.name}"
		#tellraw @a {\
			...
			"color": "red",\
			"with": [ "{NEUN_SCRIPT:builtin.minecraft_version_info.initial_release.name}", "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}" ]\
		}
	#NEUN_SCRIPT end

	#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.initial_release.name}" != "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_release.name}"
		#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_release.name}" = "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}"
			#tellraw @a {\
		...
		#NEUN_SCRIPT if "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_release.name}" != "{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}"
			#tellraw @a {\
				...
				"with": [\
					...
					"{NEUN_SCRIPT:builtin.minecraft_version_info.latest_snapshot.name}"\
				]\
			}
		#NEUN_SCRIPT end
	#NEUN_SCRIPT end
