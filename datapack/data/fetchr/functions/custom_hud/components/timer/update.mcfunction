...
data modify storage io.fetchr:custom_hud component set from storage fetchr:custom_hud default[{id: "fetchr:timer"}]
...
execute if score $custom_hud/timer.daytime fetchr.tmp matches ..11894 run function fetchr:custom_hud/components/timer/update/106_11894
execute if score $custom_hud/timer.daytime fetchr.tmp matches 11895..20702 run function fetchr:custom_hud/components/timer/update/11895_20702
execute if score $custom_hud/timer.daytime fetchr.tmp matches 20703.. run function fetchr:custom_hud/components/timer/update/20703_23745
...
data modify storage fetchr:custom_hud players[].components[{id: "fetchr:timer", slot_id: 0b}] set from storage io.fetchr:custom_hud component
execute if data storage fetchr:custom_hud players[].components[{id: "fetchr:timer", changed: false}] run function fetchr:custom_hud/components/timer/eval_non_default