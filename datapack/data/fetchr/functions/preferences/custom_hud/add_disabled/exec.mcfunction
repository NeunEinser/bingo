...
execute if score @s fetchr.pref matches 12..17 run function fetchr:preferences/custom_hud/add_disabled/partition_0
execute if score @s fetchr.pref matches 18..23 run function fetchr:preferences/custom_hud/add_disabled/partition_1
execute if score @s fetchr.pref matches 24..31 run function fetchr:preferences/custom_hud/add_disabled/partition_2
...
execute if score $preferences/hud/add.col fetchr.tmp matches 0 run function fetchr:preferences/custom_hud/add_to_col0
execute if score $preferences/hud/add.col fetchr.tmp matches 1 run function fetchr:preferences/custom_hud/add_to_col1

execute unless data storage tmp.fetchr:preferences/hud pageElements[1] run scoreboard players remove @s fetchr.menu_page 1

scoreboard players set $preferences.next_page fetchr.tmp 5
execute if score @s fetchr.menu_page matches 0.. run scoreboard players set $preferences.next_page fetchr.tmp 6