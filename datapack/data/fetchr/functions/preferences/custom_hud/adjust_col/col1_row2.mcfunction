...
execute if score @s fetchr.pref matches 58 run data modify storage tmp.fetchr:preferences/hud swap set from storage fetchr:custom_hud currentPlayer.components[7]
execute if score @s fetchr.pref matches 58 run data modify storage fetchr:custom_hud currentPlayer.components[7] set from storage fetchr:custom_hud currentPlayer.components[6]
execute if score @s fetchr.pref matches 58 run data modify storage fetchr:custom_hud currentPlayer.components[6] set from storage tmp.fetchr:preferences/hud swap

execute if score @s fetchr.pref matches 59 run data modify storage tmp.fetchr:preferences/hud toBeAdded set from storage fetchr:custom_hud currentPlayer.components[7]
execute if score @s fetchr.pref matches 59 run function fetchr:preferences/custom_hud/add_to_col0
