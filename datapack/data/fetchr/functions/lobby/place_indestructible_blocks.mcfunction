...
execute if score $is_multiplayer fetchr.state matches 1 as @e[type=minecraft:marker, tag=fetchr.multiplayer_door] at @s unless block ~ ~ ~ minecraft:iron_door run setblock ~ ~ ~ minecraft:iron_door[facing=south]
execute if score $is_multiplayer fetchr.state matches 1 as @e[type=minecraft:marker, tag=fetchr.multiplayer_door] at @s unless block ~ ~1 ~ minecraft:iron_door run setblock ~ ~1 ~ minecraft:iron_door[facing=south,half=upper]
execute if score $is_multiplayer fetchr.state matches 0 as @e[type=minecraft:marker, tag=fetchr.multiplayer_door] at @s run fill ~ ~ ~ ~ ~1 ~ minecraft:gray_concrete
...
execute if score $is_multiplayer fetchr.state matches 0 as @e[tag=fetchr.multiplayer_only] at @s if block ~ ~ ~ #fetchr:lobby_indestructible_blocks run setblock ~ ~ ~ minecraft:air
execute if score $is_multiplayer fetchr.state matches 1 as @e[tag=fetchr.singleplayer_only] at @s if block ~ ~ ~ #fetchr:lobby_indestructible_blocks run setblock ~ ~ ~ minecraft:air
