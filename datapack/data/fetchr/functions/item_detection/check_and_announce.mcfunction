...
execute if score $lockout_mode fetchr.settings matches 1 unless data storage tmp.fetchr:item_detection slot{itemCollected: true} run function fetchr:item_detection/set_overlay
