...
title @a[tag=fetchr.in_team] subtitle [{"translate":"fetchr.goal.points.subtitle.won"}]
title @a[predicate=fetchr:is_in_game, tag=!fetchr.in_team] subtitle [{"translate":"fetchr.goal.points.subtitle.lost"}]
title @a[tag=fetchr.in_team] title [{"translate":"fetchr.goal.points.title.won", "color": "green"}]
title @a[predicate=fetchr:is_in_game, tag=!fetchr.in_team] title [{"translate":"fetchr.goal.points.title.lost", "color": "red"}]
