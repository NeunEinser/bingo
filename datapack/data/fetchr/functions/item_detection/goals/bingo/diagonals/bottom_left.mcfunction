...
execute store success score $item_detect/bingo/diagonal/bl/1.success fetchr.tmp run data modify storage tmp.fetchr:item_detect/bingo/diagonal/bottom_left icon set from storage fetchr:card teams[-1].slots[4]
execute if score $item_detect/bingo/diagonal/bl/1.success fetchr.tmp matches 1 run function fetchr:item_detection/goals/bingo/diagonals/bottom/2