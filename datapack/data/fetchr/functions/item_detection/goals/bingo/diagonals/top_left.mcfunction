...
execute store success score $item_detect/bingo/diagonal/tl/1.success fetchr.tmp run data modify storage tmp.fetchr:item_detect/bingo/diagonal/top_left icon set from storage fetchr:card teams[-1].slots[0]
execute if score $item_detect/bingo/diagonal/tl/1.success fetchr.tmp matches 1 run function fetchr:item_detection/goals/bingo/diagonals/top/2