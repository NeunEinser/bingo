...
execute if score $item_detect/announce/lockout.current_item_count fetchr.tmp = $item_detect/announce/lockout.first_place fetchr.tmp run function fetchr:item_detection/goals/lockout/tag_team_members
