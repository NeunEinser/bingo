...
execute if score $item_detect/announce/lockout.first_place fetchr.tmp > $item_detect/announce/lockout.second_place fetchr.tmp run function fetchr:item_detection/goals/lockout/announce

execute if score $item_detect/announce/lockout.first_place fetchr.tmp = $item_detect/announce/lockout.second_place fetchr.tmp if score $item_detect/announce/lockout.open_items fetchr.tmp matches 0 run function fetchr:item_detection/goals/lockout/announce