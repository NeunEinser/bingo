...
execute positioned ~-151 -64 ~-151 as @e[type=!#fetchr:keep_in_skybox, tag=!fetchr.generated_entity, dx=304, dy=384, dz=304] run function fetchr:game/start/pre_gen/kill_non_generated_entity
